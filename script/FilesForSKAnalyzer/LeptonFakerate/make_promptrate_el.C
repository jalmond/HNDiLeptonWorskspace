...
void make_promptrate_el(int era){
  ...
  TString outfile = "rootfiles/HNL_PromptRate_Electron_"+s_era+".root";
  ...
  for(auto i : electron_ids){
    ...
    TString denom = "Prompt_LooseEE_" + i +"_EE_TZ_ptcone_eta";
    TString num   = "Prompt_TightEE_" + i +"_EE_TZ_ptcone_eta";
    ...
    TString name = i+"_ptcone_eta_Prescaled";
    
    TH2F* file_fake_rate = (TH2F*)hist_pt_num->Clone((name));
