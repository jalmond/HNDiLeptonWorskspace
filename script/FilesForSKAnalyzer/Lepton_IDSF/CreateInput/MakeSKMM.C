...
void MakeSKMM(TString year,TString dataset="Electron"){
  ...
  TString outfile = "HNL_Efficiencies_muon_Run"+year+"_ID.root";
  ...
  for(auto i : IDs){
    ...
    TString denom = "Muon_denominator_"+i+"_pt_eta";
    TString num = "Muon_numerator_"+i+"_pt_eta";
    ...
    TH2F* eff_rate = (TH2F*)h_pt_num->Clone(("NUM_"+name+"_DEN_TrackerMuons_abseta_pt").Data());
