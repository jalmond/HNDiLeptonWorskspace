...
void MakeFRFile(TString year, TString dataset="EE",TString PtType="Pt" ){
  ...
  TString path= "/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_Lepton_FakeRate/"+year+"/RunRatesTauAnalysisEE__/HNL_Lepton_FakeRate_Data_FakeElectron.root";
  TString mcpath= "/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_Lepton_FakeRate/"+year+"/RunRatesTauAnalysisEE__/HNL_Lepton_FakeRate_MC.root";
  ...
  TString outfile = "FR_EGamma_"+era+"_HNL_WR_Tau_"+PtType+"_v1.root";
  ...
  std::vector<TString> IDs = {"WRTau_ResolvedEE_AJ40_pt_eta", "WRTau_BoostedEE_AJ40_pt_eta"};
  ...
  for(unsigned int i=0; i < IDs.size(); i++){
    ...
    TString SaveName = (ID+"_"+Year+"_"+name);
