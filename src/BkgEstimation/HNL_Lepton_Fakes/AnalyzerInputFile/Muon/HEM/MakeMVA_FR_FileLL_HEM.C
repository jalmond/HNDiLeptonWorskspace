...
void MakeFRFile(TString year, TString dataset="MuMu",TString PtType="Pt" ){
  ...
  TString path= TString(std::getenv("FILE_MERGED_PATH")) + "HNL_Lepton_FakeRate/Jan27_HEM/"+year+"/HNL_Lepton_FakeRate_Data_FakeMuon.root";
  TString mcpath= TString(std::getenv("FILE_MERGED_PATH")) + "HNL_Lepton_FakeRate/Jan27_HEM/"+year+"/HNL_Lepton_FakeRate_MC.root"; 
