...
void MakeFRFile(TString year, TString dataset="EE",TString PtType="Pt" ){
  ...
  TString path= "/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonFakeRate/"+year+"/RunRatesNonSNU__/HNL_LeptonFakeRate_Data_FakeMuon.root";

  TString mcpath= "/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonFakeRate/"+year+"/RunRatesNonSNU__/HNL_LeptonFakeRate_MC.root";
  ...
  TString outfile = "FR_Mu_"+era+"_HNL_"+PtType+".root";

  TFile* fout = new TFile(outfile.Data(),"RECREATE");
  fout->cd();

  std::vector<TString> IDs = {"PekingMuMu_Central_pt_eta",
			      "HNTightV2MuMu_Central_pt_eta"};
