...
void FakeRatePlotterData2(){
  ...
  for (auto Era : Eras){
	...
	for( auto  var : Vars){
	  ...
	  TString VAR = "PtParton_"+EtaBin+"_AJ";
	  ...
	  TString NUM = "PtParton/Fake_PtParton_TightMuMu_"+ID+"_"+Era+"MuMu_AJ30_pt_"+EtaBin+"";
	  TString DENOM= "PtParton/Fake_PtParton_LooseMuMu_"+ID+"_"+Era+"MuMu_AJ30_pt_"+EtaBin+"";

          TString NUM25 = "PtParton/Fake_PtParton_TightMuMu_"+ID+"_"+Era+"MuMu_AJ25_pt_"+EtaBin+"";
          TString DENOM25= "PtParton/Fake_PtParton_LooseMuMu_"+ID+"_"+Era+"MuMu_AJ25_pt_"+EtaBin+"";
	  
          TString NUM40 = "PtParton/Fake_PtParton_TightMuMu_"+ID+"_"+Era+"MuMu_AJ40_pt_"+EtaBin+"";
          TString DENOM40= "PtParton/Fake_PtParton_LooseMuMu_"+ID+"_"+Era+"MuMu_AJ40_pt_"+EtaBin+"";


	  TH1D *hist_Numerator     = Plotter.ConstructHist(pathData,      "PtParton/Fake_PtParton_TightMuMu_"+ID+"_"+Era+"MuMu_AJ30_pt_"+EtaBin+"");
	  TH1D *hist_Denominator   = Plotter.ConstructHist(pathData,      "PtParton/Fake_PtParton_LooseMuMu_"+ID+"_"+Era+"MuMu_AJ30_pt_"+EtaBin+"");
	  
	  // 25
          TH1D *hist_Numerator25     = Plotter.ConstructHist(pathData,      "PtParton/Fake_PtParton_TightMuMu_"+ID+"_"+Era+"MuMu_AJ25_pt_"+EtaBin+"");
          TH1D *hist_Denominator25   = Plotter.ConstructHist(pathData,      "PtParton/Fake_PtParton_LooseMuMu_"+ID+"_"+Era+"MuMu_AJ25_pt_"+EtaBin+"");

	  // 40 
          TH1D *hist_Numerator40     = Plotter.ConstructHist(pathData,      "PtParton/Fake_PtParton_TightMuMu_"+ID+"_"+Era+"MuMu_AJ40_pt_"+EtaBin+"");
          TH1D *hist_Denominator40   = Plotter.ConstructHist(pathData,      "PtParton/Fake_PtParton_LooseMuMu_"+ID+"_"+Era+"MuMu_AJ40_pt_"+EtaBin+"");
