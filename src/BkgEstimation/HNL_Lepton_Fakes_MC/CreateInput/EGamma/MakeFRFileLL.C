...
void MakeFRFile(TString year, TString dataset="EE",TString PtType="Pt" ){
  ...
  TString path= "/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonFakeRate/"+year+"/RunRatesEE__/HNL_LeptonFakeRate_Data_FakeElectron.root";
  TString mcpath= "/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonFakeRate/"+year+"/RunRatesEE__/HNL_LeptonFakeRate_MC.root";
  ...
  TString outfile = "FR_EGamma_"+era+"_HNL_ULID_"+PtType+".root";

  TFile* fout = new TFile(outfile.Data(),"RECREATE");
  fout->cd();

  std::vector<TString> IDs = {"HNL_ULID_FOEE_Central_pt_eta",
                              "HNL_ULID_FOEE_Central_LF_pt_eta",
                              "HNL_ULID_FOEE_Central_HF1_pt_eta",
                              "HNL_ULID_FOEE_Central_HF2_pt_eta",
                              "HNL_ULID_FOEE_Central_HF3_pt_eta",
                              "HNL_ULID_FOv2EE_Central_pt_eta",
                              "HNL_ULID_FOv3EE_Central_pt_eta",
                              "HNL_ULID_FOv4EE_Central_pt_eta",
                              "HNL_ULID_FOv5EE_Central_pt_eta",
                              "HNL_ULID_FOv6EE_Central_pt_eta"};
  ...
  for(unsigned int i=0; i < IDs.size(); i++){
    ...
    if(IDs[i] == "HNL_ULID_FOEE_Central_pt_eta")      name =  "pt_eta_HNL_ULID_FO";
    if(IDs[i] == "HNL_ULID_FOEE_Central_LF_pt_eta")  name = "LF_pt_eta_HNL_ULID_FO";
    if(IDs[i] == "HNL_ULID_FOEE_Central_HF1_pt_eta") name = "HF1_pt_eta_HNL_ULID_FO";
    if(IDs[i] == "HNL_ULID_FOEE_Central_HF2_pt_eta") name = "HF2_pt_eta_HNL_ULID_FO";
    if(IDs[i] == "HNL_ULID_FOEE_Central_HF3_pt_eta") name = "HF3_pt_eta_HNL_ULID_FO";
    if(IDs[i] == "HNL_ULID_FOv2EE_Central_pt_eta") name = "pt_eta_HNL_ULID_FOv2";
    if(IDs[i] == "HNL_ULID_FOv3EE_Central_pt_eta") name = "pt_eta_HNL_ULID_FOv3";
    if(IDs[i] == "HNL_ULID_FOv4EE_Central_pt_eta") name = "pt_eta_HNL_ULID_FOv4";
    if(IDs[i] == "HNL_ULID_FOv5EE_Central_pt_eta") name = "pt_eta_HNL_ULID_FOv5";
    if(IDs[i] == "HNL_ULID_FOv6EE_Central_pt_eta") name = "pt_eta_HNL_ULID_FOv6";
