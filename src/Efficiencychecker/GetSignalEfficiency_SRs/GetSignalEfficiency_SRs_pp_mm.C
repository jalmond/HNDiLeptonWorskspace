...
void GetSignalEfficiency_SRs_pp_mm(TString _sr="SR1", TString analysername="HNtypeI_Dilepton" ,TString _chan = "Schannel",bool setlog_axis=false, TString x_range="all"){ 
  ...
  for(unsigned int k = 0 ; k < channel.size(); ++k){
	...
	TString n_sr_hist1 = _sr + "_highmass/"+_sr+"_highmass_njets_"+analysername+"_"+flavour+"_" + _id +"_";
	...
	_vgraphs.push_back(gtmp);
      ...
      TString canvasname2=_sr+"_highmass2_njets_"+analysername+"_"+_channel;
