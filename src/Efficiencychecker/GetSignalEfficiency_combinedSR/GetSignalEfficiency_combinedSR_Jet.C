...
void GetSignalEfficiency_combinedSR_Jet(TString analysername="HNtypeI_Dilepton" ,TString _chan = "Schannel",bool setlog_axis=false, TString x_range="all"){ 
  ...
  vector <TString> channel ={"MuMu"};

  vector<TString> elIDs = {"",
			   "ak4_eta25_pileup_loose",
			   "ak4_eta25_pileup_medium",
			   "ak4_eta25_pileup_tight",
			   "ak4_eta27_pileup_loose",
                           "ak4_eta27_pileup_medium",
                           "ak4_eta27_pileup_tight"};
  /*vector<TString> elIDs = {"",

			   "ak8_eta2_5_dr08",
			   "ak8_eta2_5_dr1",
			   "ak8_eta2_5_nocleaning",
			   "ak8_eta2_7_dr08",
			   "ak8_eta2_7_dr1",
			   "ak8_eta2_7_nocleaning",
			   "ak8_eta5_0_dr1",
			   "ak8_tau21_eta2_5_dr08",
			   "ak8_tau21_eta2_5_dr1",
			   "ak8_tau21_eta2_7_dr08",
                           "ak8_tau21_eta2_7_dr1",
			   "ak8_tau21_eta5_0_dr1"};
  */			   
			   
			   
  /*

SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTight_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak4_eta25_pileup_loose_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak4_eta25_pileup_medium_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak4_eta25_pileup_tight_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak4_eta27_pileup_loose_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak4_eta27_pileup_medium_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak4_eta27_pileup_tight_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_eta2_5_dr08_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_eta2_5_dr1_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_eta2_5_nocleaning_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_eta2_7_dr08_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_eta2_7_dr1_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_eta2_7_nocleaning_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_eta5_0_dr1_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta2_5_dr08_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta2_5_dr1_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta2_5_nocleaning_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta2_7_dr08_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta2_7_dr1_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta2_7_nocleaning_;1	
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta5_0_dr1_
   */
  ...
  for(unsigned int j = 0 ; j < SR.size(); ++j){
	...
	TString _id = "POGTightPFIsoVeryVeryTight";
	TString _jettag = IDs[l];
	...
	for(unsigned int i = 0 ; i < masses.size(); ++i){
	  ...
	  //SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak4_eta25_pileup_tight_
	  TString n_sr_hist1 = SR[j].second.first + "_highmass/"+SR[j].second.first+"_highmass_njets_"+analysername+"_"+_channel+"_" + _id +_jettag+"_";
	  TString n_sr_hist2 = SR[j].second.second + "_highmass/"+SR[j].second.second+"_highmass_njets_"+analysername+"_"+_channel+"_" + _id+_jettag+"_";	  
	...
	AllLegendEntry(legend_g,_vgraphs[ig],_sr+":"+IDs[ig],"lp");
      ...
      TString save_sg= output + "/Jet_hist_"+_sr+"highmass_CombinedSR1SR2_"+analysername+"_"+_chan+"_"+_channel+".pdf";
