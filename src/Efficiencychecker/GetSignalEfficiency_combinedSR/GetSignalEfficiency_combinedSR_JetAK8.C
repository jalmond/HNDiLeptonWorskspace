...
void GetSignalEfficiency_combinedSR_JetAK8(TString analysername="HNtypeI_Dilepton" ,TString _chan = "Schannel",bool setlog_axis=false, TString x_range="all"){ 
...
SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTight_;1	
 ...
 KEY: TH1D	SR1_highmass_njets_HNtypeI_Dilepton_MuMu_POGTightPFIsoVeryVeryTightak8_tau21_eta5_0_dr1_
  ...
  for(unsigned int j = 0 ; j < SR.size(); ++j){
	...
	cout << IDs[ig] << " intergal = " << _vgraphs[ig]->Integral() << endl;
	AllLegendEntry(legend_g,_vgraphs[ig],_sr+":"+IDs[ig],"lp");
      ...
      TString save_sg= output + "/AK8Jet_hist_"+_sr+"highmass_CombinedSR1SR2_"+analysername+"_"+_chan+"_"+_channel+".pdf";
