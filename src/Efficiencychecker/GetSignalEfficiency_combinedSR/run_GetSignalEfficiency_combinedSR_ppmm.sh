...
then
    ...
    root -l -q -b  GetSignalEfficiency_combinedSR_pp_mm.C
else
    echo "Running non default"
    if [[ $4 == "false" ]];
    then
	root -l -q -b 'GetSignalEfficiency_combinedSR_pp_mm.C("'$2'","'$3'",false,"'$5'")'
    else
	root -l -q -b 'GetSignalEfficiency_combinedSR_pp_mm.C("'$2'","'$3'",true,"'$5'")'
