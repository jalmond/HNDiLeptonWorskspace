...
void DrawConfig(TString DateTag ,double mass, TString smass){
  ...
  Plotter.SetupPlotter(year,"","Muon_HighPt_SmearSyst");
  ...
  TH1D *hist_Syst = Plotter.ConstructHist(path+"HNL_HighPtMuon_Studies_SkimTree_HNMultiLepBDT_HNL_M"+smass+"_private.root","SS_smearcorr_syst/Muon_ULID_v5");
  ...
  lg->AddEntry(hist_Syst,"Syst Res.","l");
  ...
  TString HNAME = DateTag+"_SignalComp_SmearSyst_"+ID +"_"+smass ;
