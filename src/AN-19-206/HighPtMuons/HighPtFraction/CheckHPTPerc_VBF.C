...
void DrawConfig(TString DateTag){
  ...
  if(GetMassListVBF.size() > 0){
    ...
    TH1D *hist_300 = Plotter.ConstructHist(path+"HNL_HighPtMuon_Studies_SkimTree_HNMultiLepBDT_VBFTypeI_DF_M300_private.root","SS/Muon1_Default_Pt_SR_Muon_ULID_v3");
    TH1D *hist_500 = Plotter.ConstructHist(path+"HNL_HighPtMuon_Studies_SkimTree_HNMultiLepBDT_VBFTypeI_DF_M500_private.root","SS/Muon1_Default_Pt_SR_Muon_ULID_v3");
    TH1D *hist_1000 = Plotter.ConstructHist(path+"HNL_HighPtMuon_Studies_SkimTree_HNMultiLepBDT_VBFTypeI_DF_M1000_private.root","SS/Muon1_Default_Pt_SR_Muon_ULID_v3");
    TH1D *hist_2000 = Plotter.ConstructHist(path+"HNL_HighPtMuon_Studies_SkimTree_HNMultiLepBDT_VBFTypeI_DF_M2000_private.root","SS/Muon1_Default_Pt_SR_Muon_ULID_v3");
    
    double percent300 = 100*hist_300->Integral(3,11) / hist_300->Integral();
    ...
    hist_300->Scale(1/hist_300->Integral());
    hist_500->Scale(1/hist_500->Integral());
    hist_1000->Scale(1/hist_1000->Integral());
    hist_2000->Scale(1/hist_2000->Integral());

    hist_axis(hist_300);
    hist_300->SetLineWidth(2.0);
    hist_300->SetLineStyle(23);      
    hist_300->GetXaxis()->SetTitle("p_{T}^{l1} (GeV)");
    hist_300->GetYaxis()->SetTitle("A.U.");
    //      hist_300->GetXaxis()->SetRangeUser(0,20);
    hist_300->GetYaxis()->SetRangeUser(0,1);
    hist_300->SetLineStyle(4);
    hist_300->Draw("hist");
    ...
    lg->SetBorderSize(0);
    lg->SetTextSize(0.03);
    lg->AddEntry(hist_300,"m_{N} = 300 GeV : " + TString::Itoa(percent300,10)+"%","l");
    ...
    TString HNAME = DateTag+"_SignalEff_Pt200_VBF_"+ID ;
