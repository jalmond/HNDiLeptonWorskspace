...
void RateIndiv(TString _Era,TString versionID, TString AJ){
  ...
  TString LabelForWeb = "FRate_2024_ANv1";
  ...
  for (auto Era : {_Era}){
    ...
    TString path="/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_UL_LONG/SKFlatAnalyzer/data/Run2UltraLegacy_v3/"+year+"/FakeRate/DataFR/MuFR/MainFiles/FR_Mu_"+Era+"_HNL_ULID_PtParton_v6.root";
    if(year == "2016preVFP") path="/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_UL_LONG/SKFlatAnalyzer/data/Run2UltraLegacy_v3/"+year+"/FakeRate/DataFR/MuFR/MainFiles/FR_Mu_2016a_HNL_ULID_PtParton_v6.root";
    if(year == "2016postVFP") path="/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_UL_LONG/SKFlatAnalyzer/data/Run2UltraLegacy_v3/"+year+"/FakeRate/DataFR/MuFR/MainFiles/FR_Mu_2016b_HNL_ULID_PtParton_v6.root";
    ...
    //==== get histogram                                                                                                                                                                                                                                                                                                                                           
    TH2D* hist_eta = (TH2D*)file->Get("HNL_ULID_"+Era+"_ptparton_etaBinning2_HNL_ULID_FO_"+versionID+"_"+AJ+"_FR_cent");
    ...
    if(year == "2016preVFP"&&versionID=="v1_a")     SaveHistogram(Plotter, hists, {year,""}, "HNL_Lepton_Fake_"+ID+"_"+versionID+AJ+"_DATA", LabelForWeb, {Label});
    if(year == "2016postVFP"&&versionID=="v2_a")     SaveHistogram(Plotter, hists, {year,""}, "HNL_Lepton_Fake_"+ID+"_"+versionID+AJ+"_DATA", LabelForWeb, {Label});
    if(year == "2017"&&versionID=="v2_a")     SaveHistogram(Plotter, hists, {year,""}, "HNL_Lepton_Fake_"+ID+"_"+versionID+AJ+"_DATA", LabelForWeb, {Label});
    if(year == "2018"&&versionID=="v3_a")     SaveHistogram(Plotter, hists, {year,""}, "HNL_Lepton_Fake_"+ID+"_"+versionID+AJ+"_DATA", LabelForWeb, {Label});
    
    SaveHistogram(Plotter, hists, {Era,versionID}, "HNL_Lepton_Fake_"+ID+"_"+versionID+AJ+"_DATA", LabelForWeb, {Label});
...
void SaveHistogram(HNLPlotter plotter,vector<TH2D*>hists, vector<TString> legname,  TString HistName, TString dirName, vector<TString> Labels){
  ...
  TCanvas* c1 = new TCanvas(HistName, "Data fake rate map for " + legname[0] + " muons ID "+legname[1],1100, 800);
  ...
  hist_empty->SetTitle("Data fake rate map for " + legname[0] + " muons ID "+legname[1] );
  ...
  hist_empty->SetName("Data fake rate map for " + legname[0] + " muons ID "+legname[1] );
  ...
  latex_title.DrawLatex(0.25, 0.95, "Data fake rate map for " + legname[0] + " muons ID "+legname[1] );

  TLatex latex_result;
  latex_result.SetNDC();
  latex_result.SetTextSize(0.03);

  c1->SetTitle("Data fake rate map for " + legname[0] + " muons ID "+legname[1]);
