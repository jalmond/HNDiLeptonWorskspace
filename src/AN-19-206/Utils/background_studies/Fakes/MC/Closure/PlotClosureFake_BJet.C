...
void PlotClosureFake_BJet(){
  ...
  for(auto era : vec) {
    ...
    for(auto etabin :  {""}){
      ...
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v0_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v1_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v1_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v1_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v2_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v2_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v2_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v3_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v3_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v3_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v4_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v4_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v4_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v5_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v5_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v5_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v6_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v6_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v6_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v7_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v7_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v7_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v8_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v8_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v8_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v9_a_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v9_b_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v9_c_"+year+"_MC",era, etabin,"MC","HNL_Fake_BJET_MCClosure_MuMu_"+TString(etabin), {2});
