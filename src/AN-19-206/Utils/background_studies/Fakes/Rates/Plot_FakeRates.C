...
void Plot_FakeRates(){
  ...
  for(auto era : Plotter.Eras()) {
    ...
    FakeRateProccessor(Plotter, "HNL_ULID_"+year, era,"HNL_ULID_2017_ptparton_eta_HNL_ULID_FO_v3_b_AJ30_FR_cent", "#mu p_{T} Parton [GeV]", "HNL_Fake_rate_basic");
...
void FakeRateProccessor(HNLPlotter Plotter,TString ID, TString Era, TString HistString, TString Xlabel, TString LabelForOutPut){
  ...
  TString path="/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_UL_LONG/SKFlatAnalyzer/data/Run2UltraLegacy_v3/2017/FakeRate/DataFR/MuFR/FR_Mu_2017_HNL_ULID_PtParton_v5.root";
