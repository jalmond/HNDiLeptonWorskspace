...
void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString DateTag, TString Method, TString Indir, TString HistString,TString LabelForOutPut,vector<double> vrebin);

void PlotClosureCF_ZMass(){
  ...
  for(auto era : Plotter.Eras()) {
    ...
    RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","HNL_ChargeFlip_Closure_ZMass", "Separate_BinnedShift", "Closure_ElectronCF_ZMass" ,  {50,60,70,80,85,90,95,100,110,130});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","CS","HNL_ChargeFlip_Closure_ZMass", "Paired_ConstShift","Closure_ElectronCF_ZMass" ,  {50,60,70,80,85,90,95,100,110,130});
...
void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString  DateTag, TString Method, TString HistString, TString Indir,TString LabelForOutPut,vector<double> vrebin){
