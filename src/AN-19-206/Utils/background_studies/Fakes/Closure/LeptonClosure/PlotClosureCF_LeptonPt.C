...
void PlotClosureCF_LeptonPt(){
  ...
  for(auto era : Plotter.Eras()) {
    ...
    RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May8","PBS","Binning1", "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt_PBS",  {2});
    RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May8","PBS","Binning3", "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt_PBS",  {2});

  }
  
}

void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString  DateTag,TString Method, TString binning, TString binTag, TString HistString, TString HistStringUp, TString HistStringDown, TString LabelForOutPut,vector<double> vrebin){
