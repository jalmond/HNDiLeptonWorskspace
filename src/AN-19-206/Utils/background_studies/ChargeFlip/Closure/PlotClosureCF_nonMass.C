...
void PlotClosureCF_nonMass(){
  ...
  for(auto era : Plotter.Eras("2017")) {
    ...
    for(auto etabin :  {"BB","EC"}){
      ...
      Plotter.XaxisMin = 0;
      Plotter.XaxisMax = 199;
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "NonCF_LepPt__W1","Closure","HNL_ChargeFlip_Closure_Z_LeptonPt_"+TString(etabin), {1});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "NonCF_LepPt__W2","Closure","HNL_ChargeFlip_Closure_Z_LeptonPt_"+TString(etabin), {1});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "NonCF_LepPt__W3","Closure","HNL_ChargeFlip_Closure_Z_LeptonPt_"+TString(etabin), {1});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "NonCF_LepPt__W4","Closure","HNL_ChargeFlip_Closure_Z_LeptonPt_"+TString(etabin), {1});
    }
  }
...
void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString EtaBin,TString HistString, TString Method, TString LabelForOutPut,vector<double> vrebin){
  ...
  TH1D *hist_mass_CF             = Plotter.ConstructHist(path,ID+"/"+Method+"/CF_LepPt", vrebin);
