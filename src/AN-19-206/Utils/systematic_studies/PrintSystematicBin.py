...
Signals=["SSWWTypeI_SF_M10000_private"]
...
for Signal in Signals:
    ...
    Histname="LimitBins/ElectronSR3"
...
for item in Results:
    ...
    for i in range(len(item[1])):
        ...
        print(f" {item[0]} Systemaic Diff [{CentralResult[1][i][0]}]=  {diff_sys}")
