...
void CheckEff(){
  ...
  for (auto ieta : Etas){
    for (auto itype : {"Fake_EE"}){
      // DrawConfig("2016",itype,"Electron_pt_"+ieta+"_HNL_HighPt_ULID_2016","Electron_pt_"+ieta+"_HNL_ULID_Defv3_FO","HNL ULID "+ieta,"HNL ULID "+ieta);
      //DrawConfig("2017",itype,"Electron_pt_"+ieta+"_HNL_HighPt_ULID_2017","Electron_pt_"+ieta+"_HNL_ULID_Defv3_FO","HNL ULID "+ieta,"HNL ULID "+ieta);
    ...
    for (auto itype : {"Fake_MuMu"}){
      DrawConfig("2016a",itype,"Muon_pt_"+ieta+"_TopHN","Muon_pt_"+ieta+"_TopHNL","HNL ULID "+ieta,"TopID "+ieta+" (loose)");
      DrawConfig("2016b",itype,"Muon_pt_"+ieta+"_TopHN","Muon_pt_"+ieta+"_TopHNL","HNL ULID "+ieta,"TopID "+ieta+"(tight)");
      //DrawConfig("2017",itype,"Muon_pt_"+ieta+"_HNL_ULID_2017","Muon_pt_"+ieta+"_TopHNL","HNL ULID "+ieta,"HNL ULID "+ieta);
    ...
    //  DrawConfig("2016a",itype,"Electron_pt_"+ieta+"_TopHNSST","Electron_pt_"+ieta+"_NoCut","HNL ULID "+ieta,"HNL ULID "+ieta);
    //  DrawConfig("2017",itype,"Electron_pt_"+ieta+"_TopHNSST","Electron_pt_"+ieta+"_NoCut","HNL ULID "+ieta,"HNL ULID "+ieta);
    //  DrawConfig("2018",itype,"Electron_pt_"+ieta+"_TopHNSST","Electron_pt_"+ieta+"_NoCut","HNL ULID "+ieta,"HNL ULID "+ieta);
    // }
    //for (auto itype : {"Prompt_MuMu","Conv_MuMu"}){
    //  DrawConfig("2016a",itype,"Muon_pt_"+ieta+"_TopHN","Muon_pt_"+ieta+"_NoCut","HNL ULID "+ieta,"HNL ULID "+ieta);
    //  DrawConfig("2017",itype,"Muon_pt_"+ieta+"_TopHN","Muon_pt_"+ieta+"_NoCut","HNL ULID "+ieta,"HNL ULID "+ieta);
    // DrawConfig("2018",itype,"Muon_pt_"+ieta+"_TopHN","Muon_pt_"+ieta+"_NoCut","HNL ULID "+ieta,"HNL ULID "+ieta);
    // }
  }  
...
void DrawConfig(TString Era, TString Type, TString sNum,TString sDen,TString lNum, TString lDen){
  ...
  HNL_Efficiency_Plotter Plotter("HNTop");
  Plotter.SetupPlotter(year,"","ID_Rates");
  Plotter.CopyToWebsite = false;
  
  TString path="/data6/Users/jalmond/2020/Plotter/HNDiLeptonWorskspace/src/AN-19-206/LeptonIDEff/Samples/Top/";
  ...
  hist_num->GetXaxis()->SetRangeUser(20,200);
  hist_denom->GetXaxis()->SetRangeUser(20,200);
  ...
  hist_empty->GetXaxis()->SetRangeUser(1,1000);
