...
void DrawConfig(TString DateTag,TString Flavour, TString era, TString HistName, TString HistName2, TString Tag, TString Label){
  ...
  for (auto year : eras){
    ...
    cout << path_dy_mass_minnlo  <<endl;
    TH1D *hist_Num = Plotter.ConstructHist(path_dy_mass,Flavour+"/"+HistName+"/Num");
    TH1D *hist_Den = Plotter.ConstructHist(path_dy_mass,Flavour+"/"+HistName+"/Denom");
    ...
    TString HNAME = DYName+DateTag+"_"+HistName +"_"+era ;
