...
void PlotClosureCF_ZMass(){
  ...
  for(auto era : Eras) {
    ...
    RunClosure("Bin3","InvPtEta3", Plotter, "HNL_ULID", era, "Oct8","CS","HNL_ChargeFlip_Closure_ZMass", "Paired_ConstShift", "Closure_ElectronCF_ZMass" ,  {50,60,70,80,85,90,95,100,110,120.,125.,130});
    RunClosure("Bin3","InvPtEta3", Plotter, "HNL_ULID", era, "Oct8","PBS","HNL_ChargeFlip_Closure_ZMass", "Separate_BinnedShift", "Closure_ElectronCF_ZMass" ,  {50,60,70,80,85,90,95,100,110,120.,125.,130});
...
void RunClosure(TString Bin, TString Binning, HNLPlotter Plotter,TString ID, TString Era, TString  DateTag, TString Method, TString HistString, TString Indir,TString LabelForOutPut,vector<double> vrebin){
  ...
  cout << ID+"/"+StatBinUp+"/ZMass/OS_Weighted_EnergyShift" << endl;
