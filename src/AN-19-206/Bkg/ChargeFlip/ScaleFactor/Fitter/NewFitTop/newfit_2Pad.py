import ROOT as rt
rt.gROOT.LoadMacro('./histFitter_2Pad.C+')
...
def RunFit(DateTag,channel, era, ID, HistName):
  ...
  filepath= os.getenv("FILE_MERGED_PATH") + "/HNL_Lepton_ChargeFlip/ScaleFactorTop/"+DateTag+"/"+era+"/HNL_Lepton_ChargeFlip_SkimTreeBDT_ScaleFactor.root"
  ...
  filepathMC= os.getenv("FILE_MERGED_PATH") + "/HNL_Lepton_ChargeFlip/ScaleFactorTop/"+DateTag+"/"+era+"/HNL_Lepton_ChargeFlip_SkimTree_DileptonBDT_DYJetsToEE_MiNNLO.root"
  print (filepath)
  fileName = "FitResults_Top"
...
Channels = ["BB_Pt1","BB_Pt2","BB_Pt3","EC_Pt1","EC_Pt2","EC_Pt3"]
