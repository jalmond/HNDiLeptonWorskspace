...
for Channel in Channels:
  for era in Eras:
    #RunFit(Channel, era, "POGTight", "ZMass_OS_CFweighted")
    #RunFit(Channel, era, "HNTightV2","ZMass_OS_CFweighted")
    year = era
    if "2016" in era:
      year = "2016"
    HNLID = "HNL_ULID"
    #BB_ZMass_OS_CFweighted
    #RunFit("Oct7",Channel, era, HNLID,"ZMass_OS_CF_PTB_weighted")
    RunFit("Oct7",Channel, era, "passHEEPID_v3","ZMass_OS_CF_PTB_weighted")
