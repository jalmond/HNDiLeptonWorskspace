...
def RunFit(DateTag,channel, era, ID, HistName):
  ...
  filepath= os.getenv("FILE_MERGED_PATH") + "/HNL_Lepton_ChargeFlip/"+Flag+"/"+DateTag+"/"+era+"/HNL_Lepton_ChargeFlip_SkimTreeBDT_ScaleFactor.root"
  ...
  filepathMC= os.getenv("FILE_MERGED_PATH") + "/HNL_Lepton_ChargeFlip/"+Flag+"/"+DateTag+"/"+era+"/HNL_Lepton_ChargeFlip_SkimTree_DileptonBDT_DYJetsToEE_MiNNLO.root"
  print (filepath)
  fileName = "FitResults_"+Flag
