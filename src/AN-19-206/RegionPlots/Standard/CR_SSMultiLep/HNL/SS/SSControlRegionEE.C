...
void SSControlRegionEE(){
  ...
  vector<TString> TriLepReg ={"HNL_TopNP_ThreeLepton_CR","HNL_WZ_ThreeLepton_CR","HNL_ZG_ThreeLepton_CR","HNL_WZ_HighPt_ThreeLepton_CR","HNL_ZG_HighPt_ThreeLepton_CR","HNL_WZ2_ThreeLepton_CR"};
  TriLepReg ={"HNL_ZG_ThreeLepton_CR"};

  vector<TString> QuadLepReg ={"HNL_ZZLoose_FourLepton_CR","HNL_ZZ_FourLepton_CR","HNL_ZZ_HighPt_FourLepton_CR"};

  //SSControlRegionJob(DATE, Eras, "EE",{"WZ_SS","ZZ_SS","WW_SS","Other_SS","NonPrompt","Conv","chargeflip"} , DiLepReg , "HNL_ControlRegion_SSCRPlots", "List3");
  //SSControlRegionJob(DATE, 3,Eras, "EEE", {"WZ_SS","ZZ_SS","WW_SS","Other_SS","NonPrompt","Conv","ConvDY"},TriLepReg, "HNL_ControlRegion_SSCRPlots", "List3");
  //SSControlRegionJob(DATE, Eras, "EEEE",{"WZ_SS","ZZ_SS","WW_SS","Other_SS","NonPrompt","Conv"}, QuadLepReg, "HNL_ControlRegion_SSCRPlots", "List3");

  //SSControlRegionJob(DATE,2, Eras, "EE",{"WZ_SS","ZZ_SS","WW_SS","Top_SS","Other_SS","NonPrompt","chargeflip","ConvV1"} , DiLepReg , "HNL_ControlRegion_SSCRPlots_ConvV1", "List3");
  //SSControlRegionJob(DATE,2, Eras, "EE", {"WZ_SS","ZZ_SS","WW_SS","Top_SS","Other_SS","NonPrompt","chargeflip","ConvV4"},DiLepReg, "HNL_ControlRegion_SSCRPlots_ConvV4", "List3");

  //SSControlRegionJob(DATE,2, Eras, "EE",{"WZ_SS","ZZ_SS","WW_SS","Top_SS","Other_SS","NonPrompt","chargeflip","ConvGENTV1"} , DiLepReg , "HNL_ControlRegion_SSCRPlots_ConvGENTV1", "List3");
  //SSControlRegionJob(DATE,2, Eras, "EE", {"WZ_SS","ZZ_SS","WW_SS","Top_SS","Other_SS","NonPrompt","chargeflip","ConvGENTV4"},DiLepReg, "HNL_ControlRegion_SSCRPlots_ConvGENTV4", "List3");
  ...
  //SSControlRegionJob(DATE,3, Eras, "EEE", {"WZ_SS","ZZ_SS","WW_SS","Top_SS","Other_SS","NonPrompt","ConvV4"},TriLepReg, "HNL_ControlRegion_SSCRPlots_ConvV4", "List3");

  //SSControlRegionJob(DATE,3, Eras, "EEE",{"WZ_SS","ZZ_SS","WW_SS","Top_SS","Other_SS","NonPrompt","ConvGENTV1"} , TriLepReg , "HNL_ControlRegion_SSCRPlots_ConvGENTV1", "List3");
  //SSControlRegionJob(DATE,3, Eras, "EEE", {"WZ_SS","ZZ_SS","WW_SS","Top_SS","Other_SS","NonPrompt","ConvGENTV4"},TriLepReg, "HNL_ControlRegion_SSCRPlots_ConvGENTV4", "List3");
...
void SSControlRegionJob(TString  DateTag,int nlep,vector<TString> Eras, TString Channel,vector<TString> Bkgs, vector<TString> Regions, TString Label,TString InputLis,TString Flag){
