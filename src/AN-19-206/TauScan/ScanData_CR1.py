...
histogram_template = "ChannelCutFlow/{}/LL/ChannelDependant_CR1"
default_histogram_path = "ChannelCutFlow/HNL_ULIDv2Default/LL/ChannelDependant_CR1"
...
for file_path in final_files:
    ...
    try:
        ...
        print(f"Saving  TauPlots/{file_path.split('/')[-1].replace('.root', '_CR1_comparison.png')}")
        canvas.SaveAs(f"TauPlots/{file_path.split('/')[-1].replace('.root', '_CR1_comparison.png')}")
