    ...
    for Channel in Channels:
        for Era in Eras:
            ...
            for SR in SRs:
                ...
                print("LimitExtractionBDT/"+ID+"/"+Channel[0]+"/M"+Mass+"_2D/LimitBins/"+Channel[1] + SR)
                SRHist = file_bkg.Get("LimitExtractionBDT/"+ID+"/"+Channel[0]+"/M"+Mass+"_2D/LimitBins/"+Channel[1] + SR)
            ...
            with open( "Text_"+DateTag+"/BDT_SR_"+Channel[0]+"_"+Era + "_"+Mass+"_Bkgs.txt" , "w") as ofile:
