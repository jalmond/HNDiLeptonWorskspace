...
void VBF_ValidationRegionCutFlowMuMu(){
  ...
  for (auto year : eras){
    for (auto channel : channels){
      ...
      HNLPlotter Plotter("HNL_ControlRegionPlotter_VBF");
      //// change def
      ...
      //// Setup plotter
      Plotter.SetupPlotter(year,"SkimTree_HNMultiLepBDT", "HNL_ControlRegionPlotter","/VBF_CR");
      ...
      Dirs = {                                "ChannelCutFlow/"+channel+"/HNL_ULID_HNL_ULID_FO_BDTFlavour_PtParton_AJ40/"+channel,
      ...
      Plotter.AddCutFlow("SSVBF_SelectedControlRegions" );    
