...
void SSControlRegionEE_Z(){

  //  vector<TString> eras =  {"2017preVFP", "2016postVFP", "2017","2018"};
  ...
  for (auto year : eras){
    for (auto channel : channels){
      ...
      HNLPlotter Plotter("HNL_ControlRegionPlotter1711EE");
      //// change def
      ...
      vector<TString> Dirs = {  "HNTightV2",
                                ...
                                "HNL_ULID_HNL_ULID_FO_Standard_PtParton_AJ40",
                                "HNL_ULID_HNL_ULID_FO_Standard_Pt_AJ40",
                                ...
                                "HNL_ULID_HNL_ULID_FO_Standard_PtParton_AJ30",
                                "HNL_ULID_HNL_ULID_FO_Standard_Pt_AJ30",
      ...
      for(auto id : Dirs) HPaths.push_back( "HNL_HighMass1Jet_TwoLepton_CR/"+channel+"/"+id+"/RegionPlots_"+channel);    
