...
void  CompareShapeCombindedLimitSR1EEShape(int i=0, int j=0, TString dirname="", int ReturnWhat=0, bool RunFullCLs=true){
...
*/
  //result_VBF_HNTightV2.txt                                                                                                                                                  100%  806     2.6KB/s   00:00    
  //result_VBF_passMVAID_noIso_WP90.txt                                                                                                                                       100%  800     2.5KB/s   00:00

  //result_VBF_passPOGTight_TTrig_HNTC.txt                                                                                                          100%  794     2.5KB/s   00:00    
  //result_VBF_passMVAID_noIso_WP90V16
  
  TGraphAsymmErrors*  ee_hn       =  GetTGraph(filepath+ "/result_VBF_HNTightV1_signalbin.txt", 20,2); /// cut and count
  //result_VBF_POGTightPFIsoVeryVeryTight_signalbin.txt
  ...
  if(channel=="MuMu"){
    ...
    tempvec_exp_17028 = {
      ...
      76.2341, 118.242, 17.2123, 24.2464, 31.61, 46.3963, 64.5734,                 89.4366, 115.964,147.772, 279.822,632.318
  ...
  dummy->SetTitle("");
  dummy->Draw("hist");
  lg_Alt->AddEntry(ee_hn,"HN Tight","l");
