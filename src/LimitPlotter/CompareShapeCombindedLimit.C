...
void  CompareShapeCombindedLimit(int i=0, int j=0, TString dirname="", int ReturnWhat=0, bool RunFullCLs=true){
  ...
  TString filepath = ENV_FILE_PATH+dataset+"/Limits/ReadLimits/out_v2/";
  ...
  TString WhichID="";
  if (i == 1) WhichID="HNTightV1";
  if (i == 2) WhichID="HNTightV2";
  if (i == 3) WhichID="POGTightWithTightIso";
  ...
  TGraphAsymmErrors*  cutandcount_bin12 =  GetTGraph(filepath+ "/result.txt", 13,1); /// cut and count
  TGraphAsymmErrors*  HNTightV1_ml1jj    =GetTGraph(filepath+ "/result_"+WhichID+"_ml1jj.txt", 12,2); /// cut and count
  TGraphAsymmErrors*  HNTightV1_ml2jj    =GetTGraph(filepath+ "/result_"+WhichID+"_ml2jj.txt", 12,3); /// cut and count
  TGraphAsymmErrors*  HNTightV1_mlljj    =GetTGraph(filepath+ "/result_"+WhichID+"_mlljj.txt", 12,4); /// cut and count
  TGraphAsymmErrors*  HNTightV1_sr    =GetTGraph(filepath+ "/result_"+WhichID+"_signalbin.txt", 12,5); /// cut and count
  ...
  dummy->SetTitle("");
  dummy->Draw("hist");
  lg_Alt->AddEntry(cutandcount_bin12,"Cut and count","l");
  lg_Alt->AddEntry(HNTightV1_ml1jj,"HNTightV1_ml1jj","l");
  lg_Alt->AddEntry(HNTightV1_ml2jj,"HNTightV1_ml2jj","l");
  lg_Alt->AddEntry(HNTightV1_mlljj,"HNTightV1_mlljj","l");
  lg_Alt->AddEntry(HNTightV1_sr,"HNTightV1_signalbins","l");

  cutandcount_bin12->Draw("lsame");
  HNTightV1_ml1jj->Draw("lsame");
  HNTightV1_ml2jj->Draw("lsame");
  HNTightV1_mlljj->Draw("lsame");
  HNTightV1_sr->Draw("lsame");
  ...
  dummy->Draw("axissame");
  c_SOnly->SaveAs(plotpath+"/"+WhichYear+"_"+channel+"comparison_"+WhichDirectoryInCutop+WhichID+".pdf"); 
