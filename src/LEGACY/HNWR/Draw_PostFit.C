...
void Draw_PostFit(int Year=2016, int WhichRegion=0){
  ...
  m.data_class = dataset+"/PostFit/"+str_Year+"/";
  if(Year<0){
    str_Year = "YearCombined";
    m.data_class = dataset+"/PostFit/";
  }
...
*/
  ...
  m.plotpath = ENV_PLOT_PATH+"/"+dataset+"/FromCPP_PostFit/"+str_Year+"/";
