	...
	for (auto var : vars){
	  ...
	  for(int ibin = 0; ibin < 4;  ibin++){
	    ...
	    for( int j1=0; j1 < 21; j1++){
	      ...
	      TString sr_hist=  "OptMuMu/Sig"+var+"_"+TString(DZ1);
	      TString sr_Fakehist=  "OptMuMu/Fake"+var+"_"+TString(DZ1);
	      TString sr_Convhist=  "OptMuMu/Conv"+var+"_"+TString(DZ1);
