...
void SignalRegionPlot(){
  ...
  vector<TString> masses= {"100","200","300","400","500","800","1000","2000","5000","10000","20000"};
  ...
  for (auto year : eras){
	...
	TString sr_hist= "LimitInput/HNL_UL/FillEventCutflow/"+channel+"SR";
	...
	TString save_pdf= output + "/Limit"+channel+"_"+year+"_"+mass+".pdf";
	TString save_png= output + "/Limit"+channel+"_"+year+"_"+mass+".png";
	
	c1->SetLogy();
	c1->SaveAs(save_pdf);
	c1->SaveAs(save_png);
	
	system("ssh jalmond@lxplus.cern.ch 'mkdir -p /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegionLimitInputNoBDT/'");
      
	system("ssh jalmond@lxplus.cern.ch 'cp  /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit/index.php /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegionLimitInputNoBDT/'");
	
	system("scp " +save_pdf+" jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegionLimitInputNoBDT/");
	system("scp " +save_png + " jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegionLimitInputNoBDT/");
