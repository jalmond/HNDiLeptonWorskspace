...
void SignalRegionPlotSR3(){
  ...
  for (auto year : eras){
	...
	TString sr_hist= "LimitSR3/"+channel+"/HNL_UL/SignalBins";
	...
	TString save_pdf= output + "/SR3"+channel+"_"+year+"_"+mass+".pdf";
	TString save_png= output + "/SR3"+channel+"_"+year+"_"+mass+".png";
	
	c1->SetLogy();
	c1->SaveAs(save_pdf);
	c1->SaveAs(save_png);
	
	system("ssh jalmond@lxplus.cern.ch 'mkdir -p /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegion3LimitInput/'");
      
	system("ssh jalmond@lxplus.cern.ch 'cp  /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit/index.php /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegion3LimitInput/'");
	
	system("scp " +save_pdf+" jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegion3LimitInput/");
	system("scp " +save_png + " jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalRegion3LimitInput/");
