...
for channel in channels:
    ...
    for mass in masses:
        ...
        HistNames=[]
        DirName = "LimitInput"
        HistName="/"+channel+"/"+CompID+"/LimitBins/ElectronSR"
        BDTMasses = ["100","400","500"]

        if mass in BDTMasses:
            DirName = "LimitInputBDT"
            HistName="/"+channel+"/"+CompID+"/"+mass+"/LimitBins/ElectronSR"
