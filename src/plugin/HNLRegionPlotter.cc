...
void HNLRegionPlotter::SetupPlotter(TString era, TString Skim, TString Analyzer){
  SkimName=Skim;
  Era=era;
...
void HNLRegionPlotter::SetupPlotter(){
...
TH1D* HNLRegionPlotter::ConstructHist(TString filepath, TString fullhistname){
...
void HNLRegionPlotter::SaveHists(vector<TH1D*>hists, vector<TString> legname, TString HistName, TString dirName, vector<TString> scales){
