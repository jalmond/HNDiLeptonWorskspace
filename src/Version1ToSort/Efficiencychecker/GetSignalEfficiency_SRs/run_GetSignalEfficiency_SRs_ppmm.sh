...
then
    ...
    root -l -q -b  GetSignalEfficiency_SRs_pp_mm.C
else
    echo "Running non default"
    if [[ $5 == "false" ]];
    then
	root -l -q -b 'GetSignalEfficiency_SRs_pp_mm.C("'$2'","'$3'","'$4'",false,"'$6'")'
    else
	root -l -q -b 'GetSignalEfficiency_SRs_pp_mm.C("'$2'","'$3'","'$4'",true,"'$6'")'
