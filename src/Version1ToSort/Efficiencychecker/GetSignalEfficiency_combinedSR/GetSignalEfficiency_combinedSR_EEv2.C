...
void GetSignalEfficiency_combinedSR_EEv2(TString analysername="HNtypeI_Dilepton" ,TString _chan = "Schannel",bool setlog_axis=false, TString x_range="all"){ 
  ...
  vector<TString> elIDs = {"passTightID","passMVAID_noIso_WP80","passMVAID_noIso_WP90","passMVAID_iso_WP80","passMVAID_iso_WP90","HEEP2018","HEEPv7"};
  ...
  for(unsigned int j = 0 ; j < SR.size(); ++j){
	...
	AllLegendEntry(legend_g,_vgraphs[ig],_sr+":"+IDs[ig],"lp");
      ...
      TString save_sg= output + "/El_hist_MVA_"+_sr+"highmass_CombinedSR1SR2_"+analysername+"_"+_chan+"_"+_channel+".pdf";
