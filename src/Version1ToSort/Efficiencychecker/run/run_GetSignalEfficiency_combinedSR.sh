...
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR HNtypeI_JA  Schannel true all
...
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR  HNtypeI_JA  Schannel false all
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR  HNtypeI_JA  Schannel false low
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR  HNtypeI_JA  Schannel false high
...
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR HNtypeI_JA  Tchannel true
...
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR HNtypeI_JA  Tchannel false all
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR HNtypeI_JA  Tchannel false low
source GetSignalEfficiency_combinedSR/run_GetSignalEfficiency_combinedSR_ppmm.sh $PWD/GetSignalEfficiency_combinedSR HNtypeI_JA  Tchannel false high
