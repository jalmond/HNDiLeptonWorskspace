...
void GetSignalOverB_combinedSR(TString channel="MuMu", TString ptbin="_HighPt", TString analysername="HNtypeI_Dilepton" ,  TString year="2016",TString _chan = "Schannel",bool setlog_axis=false, TString x_range="all"){ 
