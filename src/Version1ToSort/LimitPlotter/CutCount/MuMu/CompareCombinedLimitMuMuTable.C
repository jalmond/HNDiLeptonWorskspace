...
void CompareCombinedLimitMuMuTable(int j=0, TString dirname="", int ReturnWhat=0, bool RunFullCLs=true){
  ...
  FillMap["POGHighPtTight"] = GetMapString(filepath+ "/result_VBF_POGHighPtTight.txt", 13,1);
  FillMap["POGHighPtMixTight"] = GetMapString(filepath+ "/result_VBF_POGHighPtMixTight.txt", 13,1);
  FillMap["POGTightPFIsoMedium"] = GetMapString(filepath+ "/result_VBF_POGTightPFIsoMedium.txt", 13,1);
  FillMap["POGTightPFIsoTight"] = GetMapString(filepath+ "/result_VBF_POGTightPFIsoTight.txt", 13,1); 
  FillMap["POGTightPFIsoVeryTight"] = GetMapString(filepath+ "/result_VBF_POGTightPFIsoVeryTight.txt", 13,1); 
  FillMap["POGTightPFIsoVeryVeryTight"] =GetMapString(filepath+ "/result_VBF_POGTightPFIsoVeryVeryTight.txt", 13,1);
