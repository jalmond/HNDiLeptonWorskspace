	...
	for (auto var : vars){
	  ...
	  for(int ibin = 0; ibin < 4;  ibin++){
	    ...
	    for( int j1=0; j1 < n; j1++){
	      ...
	      TString sr_hist=  "OptEE/Sig"+var+"_"+TString(MVA1);
	      TString sr_Fakehist=  "OptEE/Fake"+var+"_"+TString(MVA1);
	      TString sr_ExtConvhist=  "OptEE/ExtConv"+var+"_"+TString(MVA1);
	      TString sr_IntConvhist=  "OptEE/IntConv"+var+"_"+TString(MVA1);
	      TString sr_CFhist=  "OptEE/CF"+var+"_"+TString(MVA1);
