	...
	for (auto var : vars){
	  ...
	  for(int ibin = 0; ibin < 4;  ibin++){
	    ...
	    for( int j1=0; j1 < n; j1++){
	      ...
	      x[j1] = MVA_1;
	      y[j1]  = (binned_int / nom_int) / sqrt(binned_fake_int / nom_fake_int);
	    ...
	    TString save_pdf= output + "/LeptonVarSig_"+save_var+"_"+channel+"_"+year+"_"+binlabel+".pdf";
	    TString save_png= output + "/LeptonVarSig_"+save_var+"_"+channel+"_"+year+"_"+binlabel+".png";
