...
void MakeFRFile(TString year,TString dataset="Muon"){
  ...
  TString path= "/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonFakeRate/"+year+"/HNL_LeptonFakeRate_data.root"; 
  TString mcpath= "/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonFakeRate/"+year+"/HNL_LeptonFakeRate_mc.root"; 
  ...
  TString era=year;
  if( era.Contains("2016")) era = "2016";
  std::vector<TString> IDs = {"HNL_ULID_"+era};

  for(unsigned int i=0; i < IDs.size(); i++){
   

    
    TString denom = "Fake_LooseMuMu_" +IDs[i] +"_MuMu_40_pt_eta";
    TString num   = "Fake_TightMuMu_" +IDs[i] +"_MuMu_40_pt_eta";
    ...
    //FakeRate Fake_TightEE_El_POGM_ISOB0.15_ISOEC0.15_DXYB1EC1_MuMu_40_ptratio_eta ptratio_eta   central  FakeRate13TeV_el_2018_mva.root
    //cout << "FakeRate\t Fake_TightMuMu_Mu_" +IDs[i] +"_MuMu_40 ptratio_eta"  << "\t" << "central " << outfile << endl;
    TH2D* eff_rate = (TH2D*)h_pt_num->Clone((name+"_pt_eta_AwayJetPt40").Data());
