...
for Year in Years:
    for Channel in Channels:
        for sample in Samples:
            ...
            dirName = Region +"/HNL_SR1_mn1000_nevent_Version1_Muon"
            ...
            for Syst in Systematics:
                ...
                systup = Region +"/HNL_SR1_mn1000_nevent_Syst_"+Syst+"Up_HNType1_Muon"
                h_systup = f_data.Get(systup)
                v_systup = y_data
                if h_systup:
                    v_systup = h_systup.Integral()
                
                systdown = Region + "/HNL_SR1_mn1000_nevent_Syst_"+Syst+"Down_HNType1_Muon"
