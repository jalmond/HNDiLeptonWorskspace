...
for Year in Years:
    for Channel in Channels:
        for sample in Samples:
            ...
            dirName = Region +"/Version1_MuonHNL_SSWW_nevent_"
            ...
            for Syst in Systematics:
                ...
                systup = Region +"/Syst_"+Syst+"Up_HNType1_Muon"+Region+"_nevent_"
                h_systup = f_data.Get(systup)
                v_systup = y_data
                if h_systup:
                    v_systup = h_systup.Integral()
                
                systdown = Region +"/Syst_"+Syst+"Down_HNType1_Muon"+Region+"_nevent_"
