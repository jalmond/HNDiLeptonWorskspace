...
void MakePUFileMM(TString year="2016",TString dataset="Muon"){
  ...
  TString outfile = "PileupRate13TeV_mu_"+year+".root";
  ...
  for(unsigned int i=0; i < fakes40.size(); i++){
    ...
    TString denom = "Z_MuMu_/Z_MuMu__nPV_HNtypeI_JA_MuMu_"+fakes40[i];
