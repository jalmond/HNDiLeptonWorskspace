...
void HNL_SignalEfficiencyLooseBreakDownLogX(){
  ...
  for (auto era : eras){
	...
	if(1){
	  ...
	  FormatHist(hNumL,rebin,-999,10,2000., GetHistColor(0),1, "P_{T} GeV","Events ");
	  FormatHist(hNumCut1,rebin,-999,10,2000., GetHistColor(1),1, "P_{T} GeV","Events ");
	  FormatHist(hNumCut2,rebin,-999,10,2000., GetHistColor(2),1, "P_{T} GeV","Events ");
	  FormatHist(hNumCut3,rebin,-999,10,2000., GetHistColor(3),1, "P_{T} GeV","Events ");
	  FormatHist(hNumCut4,rebin,-999,10,2000., GetHistColor(4),1, "P_{T} GeV","Events ");
	  FormatHist(hNumMVA,rebin,-999,10,2000., GetHistColor(5),9, "P_{T} GeV","Events ");
	  FormatHist(hNumHNLID,rebin,-999,10,2000., GetHistColor(0),9, "P_{T} GeV","Events ");
	  ...
	  hist_axis(hMediumR);
	  hMediumR->GetXaxis()->SetRangeUser(10., 1000.);
	  hMediumR->Draw("hist");
	  ...
	  TString labelMVA = "MVA ID Eff. = "+TString(to_string(EffHNL))+"%";
          DrawLatexWithLabel(era,labelMedium,0.7,0.28);
          DrawLatexWithLabel(era,labelMVA,0.7,0.18);
