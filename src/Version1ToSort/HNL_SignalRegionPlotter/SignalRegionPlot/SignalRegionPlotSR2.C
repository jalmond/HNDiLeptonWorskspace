...
void SignalRegionPlotSR2(){
  ...
  for (auto year : eras){
	...
	TString sr_hist= "LimitSR2/"+channel+"/HNL_UL/HT_LT1_Central";
	...
	TString save_pdf= output + "/SR2"+channel+"_"+year+"_"+mass+".pdf";
	TString save_png= output + "/SR2"+channel+"_"+year+"_"+mass+".png";
