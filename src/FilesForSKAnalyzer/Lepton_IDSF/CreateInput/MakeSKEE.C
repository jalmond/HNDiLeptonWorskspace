...
void MakeSKEE(TString year,TString dataset="Electron"){

  
  TString path= "/Users/john/GIT/HNDiLeptonWorskspace/rootfiles/LepScaleFactorCalc/"+year+"/LepScaleFactorCalc_data_Electron.root";
  TString mcpath= "/Users/john/GIT/HNDiLeptonWorskspace/rootfiles/LepScaleFactorCalc/"+year+"/LepScaleFactorCalc_DYJetsToEE_MiNNLO.root";
  ...
  TString outfile = "HNL_egammaEffi.txt_EGM2D_UL"+year+".root";
...
hadd Target path: /Users/john/HNDiLeptonWorskspace/OutputTool/MergedFiles/FakeRateHN/2018/FakeRateHN_SkimTree_HNFake_MC.root:/SingleTightElJet_matched_passTightID_nocc
  ...
  for(auto i : IDs){
    ...
    TString denom = "Electron_denominator_"+i+"_pt_eta";
    TString num = "Electron_numerator_"+i+"_pt_eta";
    ...
    TH2F* eff_rate = (TH2F*)h_pt_num->Clone(("EGamma_SF2D_"+name).Data());

    eff_rate->Divide(eff_rate,h_pt_denom,1.,1.,"cl=0.683 b(1,1) mode");

    h_pt_num->Divide(h_pt_num,h_pt_denom,1.,1.,"cl=0.683 b(1,1) mode");
    h_mcpt_num->Divide(h_mcpt_num,h_mcpt_denom,1.,1.,"cl=0.683 b(1,1) mode");
    eff_rate->Divide(h_mcpt_num);
    h_pt_num->Write();
    h_mcpt_num->Write();
    eff_rate->Write();
  }
