...
void MakeFRFileEE(TString year,TString dataset="Electron"){
  ...
  TString path= "/Users/john/GIT/HNDiLeptonWorskspace/OutputTool/MergedFiles/FakeRateHN/"+year+"/FakeRateHN_SkimTree_HNFake_"+dataset+".root";
  TString mcpath= "/Users/john/GIT/HNDiLeptonWorskspace/OutputTool/MergedFiles/FakeRateHN/"+year+"/FakeRateHN_SkimTree_HNFake_MC.root";
  ...
  for(unsigned int i=0; i < fakes40.size(); i++){
    ...
    for(auto j : jetpt){
      ...
      TString denom = "LooseElFakeRateHN_EE_" +fakes40[i] +"_"+j+"_ptcone_eta";
      TString num   = "TightElFakeRateHN_EE_" +fakes40[i] +"_"+j+"_ptcone_eta";
