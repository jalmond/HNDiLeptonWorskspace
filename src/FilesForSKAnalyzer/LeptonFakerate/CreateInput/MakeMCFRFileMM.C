...
void MakeMCFRFileMM(TString year="2016"){

  
  TString path= "/Users/john/HNDiLeptonWorskspace/Files/FakeRateHNMC/2016/FakeRateHNMC_QCD_Pt.root";
  ...
  TString outfile = "FakeRate13TeV_MCQCD_muon_"+year+".root";
  ...
  for(unsigned int i=0; i < fakes40.size(); i++){
    for(auto j : jetpt){
      //TightMuFakeRateHNMC_MuMu_HNTightPFIsoVeryVeryTight_20-1_ptcone_eta
      //TightElFakeRateHN_EE_HNTight2016_40_ptcorr-ptcorr
      TString denom = "LooseMuFakeRateHNMC_MuMu_" +fakes40[i] +"_"+j+"_ptcone_eta";
      TString num   = "TightMuFakeRateHNMC_MuMu_" +fakes40[i] +"_"+j+"_ptcone_eta";
