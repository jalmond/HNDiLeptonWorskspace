...
void Plot_ElCFRates_compare_shift(){
  ...
  for(auto era : Plotter.Eras()) {
    ...
    //ID = "POGTight";
    ID = "HNTightV2";
    CFRateProccessor(Plotter, ID, era,"CFrate_Eta", "#eta_{SC}", "HNL_ChargeFlip_rate_shiftcomparison");
...
void CFRateProccessor(HNLPlotter Plotter,TString ID, TString Era, TString HistString, TString Xlabel, TString LabelForOutPut){
  ...
  TString pathNoShift="/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/HNL_Lepton_ChargeFlip/"+Era+"/RateNoShift/HNL_Lepton_ChargeFlip_SkimTree_DileptonBDT_Rates.root";
