...
void PlotEnergyCFMinChi2Shift_EtaBinned(){
  ...
  for(auto era : Plotter.Eras()) {
    ...
    vector <TString> HistStrings = {"EtaBin1","EtaBin2","EtaBin3","EtaBin4","EtaBin5","EtaBin6"};
    for(auto HistString : HistStrings ) {
      TString MinChi2String = EnergyCFShiftChi2(Plotter, "HNL_ULID_"+year, era,HistString, "HNL_ChargeFlip_EtaBinned_EnergyShift");
      Results.push_back( "MinChi2String = " + MinChi2String + " EtaBin = " + HistString +" era = "+era );
    }
