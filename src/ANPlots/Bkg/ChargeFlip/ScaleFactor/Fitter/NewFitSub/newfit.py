...
def RunFit(DateTag,channel, era, ID, HistName):
  ...
  filepath= os.getenv("FILE_MERGED_PATH") + "/HNL_Lepton_ChargeFlip/"+DateTag+"/"+era+"/ScaleFactor/HNL_Lepton_ChargeFlip_SkimTreeBDT_Comb_ScaleFactor.root"
