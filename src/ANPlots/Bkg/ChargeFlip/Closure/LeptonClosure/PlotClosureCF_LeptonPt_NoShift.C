...
void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString DateTag, TString Method, TString binCF,TString binning, TString binTag, TString HistString,TString LabelForOutPut,vector<double> vrebin);

void PlotClosureCF_LeptonPt_NoShift(){
  ...
  for(auto era : Plotter.Eras()) {
    ...
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","Binning1",    "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF_LowPt" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","Binning3",    "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF_LowPt" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","BinningEta",  "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF_LowPt" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","BinningEta2", "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF_LowPt" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","BinningEta2", "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF_LowPt" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140});


    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","Binning1",    "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140,200,250,330,400,500,1000});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","Binning3",    "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140,200,250,330,400,500,1000});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","BinningEta",  "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140,200,250,330,400,500,1000});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","BinningEta2", "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140,200,250,330,400,500,1000});
    RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","LeptonPt","BinningEta2", "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140,200,250,330,400,500,1000});
    //RunClosure(Plotter, "HNL_TC1_ULID_"+year, era, "May10","PBS","LeptonPt_EtaBin1","BinningEta2_Bin1", "_w_pbs","HNL_ChargeFlip_Closure_LeptonPt", "Closure_ElectronCF" ,  {15,25,30,35,40,45,50,55,60,65,70,80,90,100,140,200,250,330,400,500,1000});
...
void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString  DateTag,TString Method, TString binCF,TString binning, TString binTag, TString HistString, TString LabelForOutPut,vector<double> vrebin){
  ...
  cout << path << endl;
  TH1D *hist_mass_CF             = Plotter.ConstructHist(path,ID+"/Closure/CF_"+binCF, vrebin);
  TH1D *hist_Prompt              = Plotter.ConstructHist(path,ID+"/Closure_"+Method+"/NonCF_Fitted_"+binning+"_LeptonPt_"+binTag, vrebin);
  TH1D *hist_Prompt_NoShift      = Plotter.ConstructHist(path,ID+"/Closure_NoShift/NonCF_Fitted_"+binning+"_LeptonPt__w_nos", vrebin);

  cout << hist_mass_CF << " " << hist_Prompt << " " << hist_Prompt_NoShift << endl; 


  cout << ID+"/Closure_NoShift/NonCF_Fitted_"+binning+"_LeptonPt__w_nos" << endl;
  ...
  cout << "SF = " << hist_mass_CF->Integral() / hist_Prompt->Integral()  << endl;
...
void SaveHistogram(HNLPlotter plotter,vector<TH1D*>hists, vector<TString> legname, TString HistName, TString dirName, vector<TString> Labels){
  ...
  tmp_ratio_point->GetYaxis()->SetRangeUser(0.5,1.5);
