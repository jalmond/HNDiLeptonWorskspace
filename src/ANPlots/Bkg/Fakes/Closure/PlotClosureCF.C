...
void PlotClosureCF(){
  ...
  for(auto era : Plotter.Eras("2017")) {
    ...
    for(auto etabin :  {"BB","EC"}){
      Plotter.XaxisMin = 70.;  Plotter.XaxisMax = 110;

      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "CFrate_2DInvPt_HNL_ULID_"+year,"Standard","HNL_ChargeFlip_Closure_Zmass_"+TString(etabin), {2});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "CFrate_2DInvPt_HNL_ULID_"+year,"Standard_BinnedShift","HNL_ChargeFlip_Closure_Zmass_"+TString(etabin), {2});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "CFrate_2DInvPt_HNL_ULID_"+year,"Separate","HNL_ChargeFlip_Closure_Zmass_"+TString(etabin), {2});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "CFrate_2DInvPt_HNL_ULID_"+year,"Separate_BinnedShift","HNL_ChargeFlip_Closure_Zmass_"+TString(etabin), {2});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "CFrate_2DPt_HNL_ULID_"+year,"Standard","HNL_ChargeFlip_Closure_Zmass_"+TString(etabin), {2});
      RunClosure(Plotter, "HNL_ULID_"+year, era,etabin, "CFrate_2DPt_HNL_ULID_"+year,"Separate_BinnedShift","HNL_ChargeFlip_Closure_Zmass_"+TString(etabin), {2});
...
void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString EtaBin,TString HistString, TString Method, TString LabelForOutPut,vector<double> vrebin){
  ...
  TH1D *hist_mass_CF             = Plotter.ConstructHist(path,ID+"/ZMass/SS_"+EtaBin, vrebin);
  TH1D *hist_Prompt              = Plotter.ConstructHist(path,ID+"/"+Method+"/"+HistString+"/ZMass/OS_"+EtaBin+"_Weighted_EnergyShift", vrebin);
  TH1D *hist_Prompt_NoShift      = Plotter.ConstructHist(path,ID+"/"+Method+"/"+HistString+"/ZMass/OS_"+EtaBin+"_Weighted", vrebin);
