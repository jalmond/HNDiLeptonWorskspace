...
void PlotClosureFake_BJet_DY(){
  ...
  for(auto era : vec) {
    ...
    for(auto etabin :  {""}){
      ...
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v0_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v1_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v1_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v1_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v2_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v2_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v2_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v3_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v3_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v3_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v4_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v4_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v4_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v5_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v5_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v5_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v6_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v6_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v6_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v7_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v7_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v7_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v8_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v8_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v8_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});

      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v9_a_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v9_b_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
      RunClosure(Plotter, "MuMu_HNL_ULID_FO_v9_c_"+year+"_MC",era, etabin,"DY","HNL_Fake_BJET_DY_MCClosure_MuMu_"+TString(etabin), {2});
...
void RunClosure(HNLPlotter Plotter,TString ID, TString Era, TString EtaBin, TString Sample,TString LabelForOutPut,vector<double> vrebin){
  ...
  SaveHistogram( Plotter,{hist_Tight,hist_Loose40}, {"Fake Lepton (Tight)", "Fake Lepton (Loose)"}, ID+"_Fake_BJET_DY_MCClosure_"+EtaBin+"_"+Era, LabelForOutPut, {});
