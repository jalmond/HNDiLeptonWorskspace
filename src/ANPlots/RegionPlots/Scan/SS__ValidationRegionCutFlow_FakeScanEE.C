...
void SS__ValidationRegionCutFlow_FakeScanEE(){
  ...
  for (auto year : eras){
    for (auto channel : channels){
      ...
      HNLPlotter Plotter("HNL_ControlRegion_FakeScan_EC");
      //// change def
      ...
      //// Setup plotter
      Plotter.SetupPlotter(year,"SkimTree_HNMultiLepBDT", "HNL_ControlRegion","/ScanFakes_EC");
