...
void SSControlRegion(){
  SSControlRegionJob("April26", {"2018"}, "MuMu", {"HNL_HighMassSR3_TwoLepton_CR",					      "HNL_HighMassBJet_TwoLepton_CR","HNL_HighMassNP_TwoLepton_CR","HNL_HighMassSR1_TwoLepton_CR","HNL_HighMassSR2_TwoLepton_CR","HNL_HighMassSR3LowJet_TwoLepton_CR","HNL_HighMassSR3_2J_TwoLepton_CR","HNL_WpWpNP2_TwoLepton_CR","HNL_WpWpNP3_TwoLepton_CR","HNL_WpWpNP_TwoLepton_CR","HNL_WpWp_TwoLepton_CR1","HNL_WpWp_TwoLepton_CR2"}, "HNL_ControlRegion_SSCRPlots");
  
  SSControlRegionJob("April26", {"2018"}, "MuMuMu", {"HNL_TopNP_ThreeLepton_CR","HNL_WZ_ThreeLepton_CR","HNL_ZG_ThreeLepton_CR","HNL_WZ2_ThreeLepton_CR","HNL_WZB_ThreeLepton_CR"}, "HNL_ControlRegion_SSCRPlots");
  SSControlRegionJob("April26", {"2018"}, "MuMuMuMu", {"HNL_ZZLoose_FourLepton_CR","HNL_ZZ_FourLepton_CR"}, "HNL_ControlRegion_SSCRPlots");
