...
void HNLRegionPlotter::AddAK8(){

  AddHist("AK8/AK8J_Tagger_particleNet_WvsQCD" ,"PNET WvsQCD", "",{2},0,1);
  AddHist("AK8/AK8J_Mass/l1J" ,"m_{l_{1}J} GeV", "GeV", {0,400,800,1200,2500},0.,2500.);
...
void HNLRegionPlotter::AddMisc(){
  ...
  AddHist("SKEvent/Ev_MET2_ST"  ,"MET^{2}/S_{T}","GeV",  {0,2,4,6,8,10,15,20,40}, 0, 20);
  AddHist("SKEvent/Ev_MET"  ,"MET","GeV",  {2}, 0, 100);
  AddHist("SKEvent/HToLepPt1","H_{T}/p^{lep_{1}}_{T} GeV", "GeV", {0,2,5,10},0, 10);
}
void HNLRegionPlotter::AddMass(int nlep){
  
  AddHist("Mass/M_ll"  ,"M_{ll}"  , "GeV",    {1},0,200);

  if(nlep==3)   AddHist("Mass/M_lll"  ,"M_{lll}"  , "GeV",   {2},0,400);
  if(nlep==4)   AddHist("Mass/M_llll"  ,"M_{llll}"  , "GeV",    {1}, 0, 400);
  if(nlep==4)   AddHist("Mass/M_ZZ"  ,"M_{4l}"  , "GeV",    {1}, 0, 200);
...
void HNLRegionPlotter::AddLepton(int nlep){

  AddHist("Leptons/Lep_1_pt" ,"P^{1}_{T} GeV" , "GeV", {0, 20.,40., 50.,80., 200.,500}, 0, 500);
  AddHist("Leptons/Lep_2_pt" ,"P^{2}_{T} GeV" , "GeV", {0.,10.,15., 25.,30,40,50,100., 200.}, 0, 200);
  if(nlep==4)AddHist("Leptons/Lep_4_pt" ,"P^{4}_{T} GeV" , "GeV", {0.,10.,15., 25.,30,40,50,100., 200.}, 0, 200);
  if(nlep>=3) AddHist("Leptons/Lep_3_pt" ,"P^{3}_{T} GeV" , "GeV", {0.,10.,15., 25.,100., 200.}, 0, 200);
  AddHist("Leptons/Lepton_pt" ,"P^{1}_{T} " , "int", {0.,15.,20.,30.,40., 60.,100.,250.}, 10, 250);
...
void HNLRegionPlotter::SetupSampleInfo(){
  ...
  map_sample_string_to_list["HtoZZ"] = {"HtoZZ"};
  map_sample_string_to_list["ZX"] = {"ZX"};
  map_sample_string_to_list["ZZ"] = {"ZZ"};
  ...
  map_sample_string_to_list["Other"] = {"Other"};
  ...
  map_sample_string_to_legendinfo["ZZ"] = make_pair("ZZ", kRed);
  map_sample_string_to_legendinfo["HtoZZ"] = make_pair("HtoZZ", kCyan);
  map_sample_string_to_legendinfo["ZX"] = make_pair("ZX", kSpring-7);
  ...
  map_sample_string_to_legendinfo["Other"] = make_pair("Other", kBlue-2);
