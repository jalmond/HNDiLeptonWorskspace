...
void MakeCFFileEE(TString year,TString dataset="Electron"){

  
  TString path= "/Users/john/HNDiLeptonWorskspace/OutputTool/MergedFiles/HNtypeI_CF/"+year+"/HNtypeI_CF_SkimTree_SSNonIso_MC.root";
  ...
  TString outfile = "CFRate13TeV_el_"+year+".root";
  ...
  for(unsigned int i=0; i < fakes40.size(); i++){
    ...
    TString denom = "el_pt_eta"+ fakes40[i];
    TString num   = "el_cf_pt_eta"+ fakes40[i];
    ...
    TH2D* eff_rate = (TH2D*)h_pt_num->Clone((name+"_HNCF").Data());
