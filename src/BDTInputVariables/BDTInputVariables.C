...
void BDTInputVariablesCF(TString Era){
  ...
  HistNamesTitle["Electron_E15_Electron"+EtaBin+"_OSElectron"] = "e15";
	...
	vector<bool> LogOpt = {false,true};
	  ...
	  TH1D* Hist_DATA= (TH1D*)(File_sample->Get(FullHistName));
	  TH1D* Hist_MC = (TH1D*)(File_MCsample->Get(FullHistName));
	  ...
	  //	  TH1D* Hist_CF       = GetHist(File_AllMCsample,FullHistNameCF,ref+"F");
