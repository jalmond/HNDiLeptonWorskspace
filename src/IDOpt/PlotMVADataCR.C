...
void PlotMVADataCR(TString channel="muon", TString year="2017"){
  ...
  TString data_path ="/Users/john/GIT/HNDiLeptonWorskspace/InputFiles/rootfiles/Run2UltraLegacy_v2_Default/HNL_Signal/"+year+"/DATA/HNL_Signal_SkimTree_HNMultiLep_DoubleMuon.root";
