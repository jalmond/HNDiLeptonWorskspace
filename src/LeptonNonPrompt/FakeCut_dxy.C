...
void FakeCut_dxy(TString sample = "ZGTo2LG",TString channel="muon", TString var="dxy",TString type="-1.000000", TString year="2016"){
  ...
  double eff = data_hist->Integral(data_hist->FindBin(-0.02), data_hist->FindBin(0.02))/ data_hist->Integral();
  if ( channel.Contains("el") ) eff = data_hist->Integral(data_hist->FindBin(-0.05), data_hist->FindBin(0.05))/ data_hist->Integral();


  double effL = data_hist->Integral(data_hist->FindBin(-0.1), data_hist->FindBin(0.1))/ data_hist->Integral();
  if ( channel.Contains("el") ) effL = data_hist->Integral(data_hist->FindBin(-0.1), data_hist->FindBin(0.1))/ data_hist->Integral();

  cout << data_hist->Integral(data_hist->FindBin(-0.1), data_hist->FindBin(0.1)) << " " << data_hist->Integral() << endl;
