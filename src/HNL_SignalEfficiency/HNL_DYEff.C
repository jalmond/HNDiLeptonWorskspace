...
void HNL_TTBarEff(){
  ...
  for (auto era : eras){
    ...
    vector<TString> samples =  {"HNL_SignalEfficiency_TTLJ_powheg"};
    ...
    for(auto sample : samples){
	  ...
	  TString sHist_Loose    = DirName+LepType+"_pt_"+EtaBin+"_POGLoose";
	  TString sHist_HNLID    = DirName+LepType+"_pt_"+EtaBin+"_HNL_TopMVA_MM";
	  TString sHist_HNLV2    = DirName+LepType+"_pt_"+EtaBin+"_HNTightV2";
	  ...
	  Ratio_HNLV2IDR->Draw("hist");
	  Ratio_HNLIDR->Draw("histsame");
