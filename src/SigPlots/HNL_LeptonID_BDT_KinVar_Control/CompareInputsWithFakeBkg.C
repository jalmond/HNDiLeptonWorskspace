...
void CompareInputsWithFakeBkgEra(  TString Era1);

void CompareInputsWithFakeBkg(){
  CompareInputsWithFakeBkgEra("2016");
  CompareInputsWithFakeBkgEra("2017");
  CompareInputsWithFakeBkgEra("2018");
}

void CompareInputsWithFakeBkgEra(  TString Era1){

  TString LabelForWeb = "CompareInputs_2023_July30_ElectronPrompt";

  TString LabelForWeb2 = "CompareInputs_2023_July30_ElectronPrompt_Var2_";


  LabelForWeb = LabelForWeb + "_Fake";
  LabelForWeb2 = LabelForWeb2 + "_Fake";

  vector<TString> regs = {"Pt1_Eta1","Pt1_Eta2","Pt1_Eta3","Pt1_Eta4","Pt1_Eta5",
                          "Pt2_Eta1","Pt2_Eta2","Pt2_Eta3","Pt2_Eta4","Pt2_Eta5"};
...
void CompareInputsConfig(TString LabelForWeb,TString reg,TString Era1,  TString histname, TString axisname, int rebin, double minx, double maxx){
  ...
  TString path3="/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_ControlRegionPlotter/MVA/"+Era1+"/HNL_LeptonIDBDTStudies_SkimTree_FakeEventSkim.root";
  ...
  TH1D *hist_3     = Plotter.ConstructHist(path3,  "FakeHF/"+reg+"/Lepton_bdt_id_"+histname);
  TH1D *hist_4     = Plotter.ConstructHist(path3,  "FakeLF/"+reg+"/Lepton_bdt_id_"+histname);
  ...
  Plotter.SaveHistsWithRatio({hist_1,hist_2,hist_3,hist_4}, {"Data","DY","Fake [HF]","Fake [LF]"},Era1+"_"+reg+"_"+histname,LabelForWeb, {scale1});
