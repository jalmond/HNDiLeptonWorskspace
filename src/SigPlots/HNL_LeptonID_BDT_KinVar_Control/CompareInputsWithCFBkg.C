...
void CompareInputsWithCFBkgEra(  TString Era1);

void CompareInputsWithCFBkg(){
  CompareInputsWithCFBkgEra("2016");
  //CompareInputsWithCFBkgEra("2017");
  //CompareInputsWithCFBkgEra("2018");
}

void CompareInputsWithCFBkgEra(  TString Era1){

  TString LabelForWeb = "CompareInputs_2023_Sep30_ElectronPrompt";
  TString LabelForWeb2 = "CompareInputs_2023_Sep30_ElectronPrompt_Var2_";

  LabelForWeb = LabelForWeb + "_CF";
  LabelForWeb2 = LabelForWeb2 + "_CF";

  vector<TString> regs = {"EC_Pt1","EC_Pt2","EC_Pt3","EC_Pt4","EC_Pt5"};

    //"Pt1_Eta1","Pt1_Eta2","Pt1_Eta3","Pt1_Eta4","Pt1_Eta5",	  "Pt2_Eta1","Pt2_Eta2","Pt2_Eta3","Pt2_Eta4","Pt2_Eta5"};
...
void CompareInputsConfig(TString LabelForWeb,TString reg,TString Era1,  TString histname, TString axisname, int rebin, double minx, double maxx){
  ...
  TString path3="/data6/Users/jalmond/2020/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_ControlRegionPlotter/MVA/"+Era1+"/HNL_LeptonIDBDTStudies_SkimTree_CFEventSkim.root";
  ...
  TH1D *hist_3     = Plotter.ConstructHist(path3,  "CF/"+reg+"/Lepton_bdt_id_"+histname);
  ...
  Plotter.SaveHistsWithRatio({hist_1,hist_2,hist_3}, {"Data","DY","CF"},Era1+"_"+reg+"_"+histname,LabelForWeb, {scale1});
