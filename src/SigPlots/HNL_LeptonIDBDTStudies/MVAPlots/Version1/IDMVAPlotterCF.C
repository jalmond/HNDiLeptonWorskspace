...
void IDMVAPlotterCF(){
  ...
  for (auto Era : Eras) IDMVAPlotterCFRun2D(Era ,{"BB"} ,   PtBins, MVAStrings, "BDTVariablesNPBB4", "BDTVariables", LabelForWeb+"_2DPtBins");
  for (auto Era : Eras) IDMVAPlotterCFRun2D(Era ,{"EC"} ,   PtBins, MVAStrings, "BDTVariablesNPEC4", "BDTVariables",LabelForWeb+"_2DPtBins");
