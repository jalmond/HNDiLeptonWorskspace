...
void IDMVAPlotterNP(){
  ...
  for (auto Era : Eras) IDMVAPlotterNPRun2D(Era ,{"BB"} ,      {""}, MVAStrings,         "BDTVariablesConvCFBB1", "BDTVariables", LabelForWeb+"_2D");
  for (auto Era : Eras) IDMVAPlotterNPRun2D(Era ,{"EC"} ,      {""}, MVAStrings,      "BDTVariablesConvCFEC1", "BDTVariables",  LabelForWeb+"_2D");


  
  for (auto Era : Eras) IDMVAPlotterNPRun2D(Era ,{"BB"} ,   PtBins, MVAStrings, "BDTVariablesConvCFBB1",    "BDTVariables", LabelForWeb+"_PtBins2D");
  for (auto Era : Eras) IDMVAPlotterNPRun2D(Era ,{"BB"} ,   PtBins, MVAStrings, "SSBDTVariablesConvCFBB1",  "BDTVariables",LabelForWeb+"_PtBins2D");
  for (auto Era : Eras) IDMVAPlotterNPRun2D(Era ,{"EC"} ,   PtBins, MVAStrings, "BDTVariablesConvCFBB1",    "BDTVariables",LabelForWeb+"_PtBins2D");
  for (auto Era : Eras) IDMVAPlotterNPRun2D(Era ,{"EC"} ,   PtBins, MVAStrings, "SSBDTVariablesConvCFBB1",  "BDTVariables",LabelForWeb+"_PtBins2D");
