...
void IDMVAPlotterMuonNPRun2D(TString era, vector<TString>  EtaBins,vector<TString> PtBins,vector<TString> MVAStrings,TString InDir, TString InDirDef, TString WebSite_Label);
...
void IDMVAPlotterMuonNP(){
  ...
  //  for (auto Era : Eras) IDMVAPlotterMuonNPRun(Era , {"BB","EC" } , PtBins , MVAStrings, "BDTVariables", LabelForWeb+"_PtEtaBins");

  for (auto Era : Eras) IDMVAPlotterMuonNPRun2D(Era ,{"BB","EC"} ,      PtBins, MVAStrings,      "BDTVariablesHFNP3", "BDTVariables", LabelForWeb+"_2DPt");
  for (auto Era : Eras) IDMVAPlotterMuonNPRun2D(Era ,{"BB","EC"} ,      PtBins, MVAStrings,      "BDTVariablesHFNP4", "BDTVariables", LabelForWeb+"_2DPt");
  for (auto Era : Eras) IDMVAPlotterMuonNPRun2D(Era ,{"BB","EC"} ,      PtBins, MVAStrings,      "BDTVariablesNP2", "BDTVariables", LabelForWeb+"_2DPt");
  for (auto Era : Eras) IDMVAPlotterMuonNPRun2D(Era ,{"BB","EC"} ,      PtBins, MVAStrings,      "BDTVariablesNP3", "BDTVariables", LabelForWeb+"_2DPt");
  for (auto Era : Eras) IDMVAPlotterMuonNPRun2D(Era ,{"BB","EC"} ,      PtBins, MVAStrings,      "BDTVariablesNP4", "BDTVariables", LabelForWeb+"_2DPt");
