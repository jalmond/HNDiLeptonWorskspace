...
void MakeFileFromNtupRun(TString input_path, double pt, TString OUTNAME);
void MakeFileFromNtupRunType(TString Type);

void MakeFileFromNtupSkim(){
  
  MakeFileFromNtupRunType("ConvBkg");
  MakeFileFromNtupRunType("FakeBkg");
  MakeFileFromNtupRunType("Prompt");
}
...
void MakeFileFromNtupRunType(TString Type){
  ...
  for(auto Era : Eras) {
    //MakeFileFromNtupRun("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonID_BDT_KinVar/Version2/"+Era+"/HNL_LeptonID_BDT_KinVar_"+Type+".root", 1 , "HNL_LeptonID_BDT_KinVar_"+Type+"_SKIM30_"+Era+".root");
    //MakeFileFromNtupRun("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonID_BDT_KinVar/Version2/"+Era+"/HNL_LeptonID_BDT_KinVar_"+Type+".root", 2 , "HNL_LeptonID_BDT_KinVar_"+Type+"_SKIM40_"+Era+".root");
    //MakeFileFromNtupRun("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonID_BDT_KinVar/Version2/"+Era+"/HNL_LeptonID_BDT_KinVar_"+Type+".root", 3 , "HNL_LeptonID_BDT_KinVar_"+Type+"_SKIM50_"+Era+".root");
    //MakeFileFromNtupRun("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonID_BDT_KinVar/Version2/"+Era+"/HNL_LeptonID_BDT_KinVar_"+Type+".root", 4 , "HNL_LeptonID_BDT_KinVar_"+Type+"_SKIM60_"+Era+".root");

    MakeFileFromNtupRun("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonID_BDT_KinVar/Version2/"+Era+"/HNL_LeptonID_BDT_KinVar_"+Type+".root", 5 , "HNL_LeptonID_BDT_KinVar_"+Type+"_SKIM100_"+Era+".root");
    MakeFileFromNtupRun("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonID_BDT_KinVar/Version2/"+Era+"/HNL_LeptonID_BDT_KinVar_"+Type+".root", 6 , "HNL_LeptonID_BDT_KinVar_"+Type+"_SKIM200_"+Era+".root");
...
void MakeFileFromNtupRun(TString input_path,double pt, TString OUTNAME){
  ...
  TH1D* h_PtBinned = new TH1D("h_PtBinned","h_PtBinned", 5  , 0 ,5);
