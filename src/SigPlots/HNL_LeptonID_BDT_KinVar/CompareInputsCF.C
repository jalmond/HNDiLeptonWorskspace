...
void CompareInputsCF(){

  TString Era1="2016";
  TString Era2="2017";
  TString Era3="2018";

  TString LabelForWeb = "CompareInputsCF_2023_July4_ElectronCF";
...
void CompareInputsCFConfig(TString LabelForWeb,TString Era1, TString Era2, TString Era3,  TString histname, TString axisname, int rebin, double minx, double maxx){
  ...
  TString path1="CFFiles/HNL_LeptonID_BDT_KinVar_CFBkg_"+Era1+".root";
  TString path2="CFFiles/HNL_LeptonID_BDT_KinVar_CFBkg_"+Era2+".root";
  TString path3="CFFiles/HNL_LeptonID_BDT_KinVar_CFBkg_"+Era3+".root";
