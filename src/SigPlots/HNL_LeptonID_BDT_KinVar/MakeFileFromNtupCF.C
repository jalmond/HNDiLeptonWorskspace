...
void MakeFileFromNtup(){
  ...
  for(auto Era : Eras)   MakeFileFromNtupRun("/data6/Users/jalmond/2020/HL_SKFlatAnalyzer_ULv3/SKFlatAnalyzer/HNDiLeptonWorskspace/InputFiles/MergedFiles/Run2UltraLegacy_v3/HNL_LeptonID_BDT_KinVar/Version2/"+Era+"/HNL_LeptonID_BDT_KinVar_Prompt.root", "HNL_LeptonID_BDT_KinVar_Prompt_"+Era+".root");
