...
void MakeFRFileEEFix(TString year,TString dataset="Electron"){
...
hadd Target path: /Users/john/HNDiLeptonWorskspace/OutputTool/MergedFiles/FakeRateHN/2018/FakeRateHN_SkimTree_HNFake_MC.root:/SingleTightElJet_matched_passTightID_nocc
  ...
  for(unsigned int i=0; i < fakes40.size(); i++){
    ...
    for(auto j : jetpt){
      ...
      TString denom = "LooseElFakeRateHN_EE_" +fakes40[i] +"_"+j+"_ptcone_ptfix_eta";
      TString num   = "TightElFakeRateHN_EE_" +fakes40[i] +"_"+j+"_ptcone_ptfix_eta";
