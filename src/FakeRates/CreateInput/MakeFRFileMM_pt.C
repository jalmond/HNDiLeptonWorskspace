...
void MakeFRFileMM_pt(TString year){
  ...
  TString outfile = "FakeRate13TeV_muon_pt_"+year+".root";
  ...
  for(unsigned int i=0; i < fakes40.size(); i++){
    for(auto j : jetpt){
      ...
      TString denom = "LooseMuFakeRateHN_MuMu_" +fakes40[i] + "_"+j+"_pt_eta";
      TString num   = "TightMuFakeRateHN_MuMu_" +fakes40[i] + "_"+j+"_pt_eta";
