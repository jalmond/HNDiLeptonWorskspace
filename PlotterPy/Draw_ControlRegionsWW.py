...
if args.Category==0:
  ...
  if str_Era != 'YearCombined':
        exec('m.SampleGroups = [SampleGroup_NonPrompt_%s,SampleGroup_Conv_%s, SampleGroup_CF_%s, SampleGroup_Prompt_%s  ]'%(m.DataEra,m.DataEra, m.DataEra,m.DataEra))
  else:
  ...
  m.RegionsToDraw = [
    ...
    Region('HNL_WpWp_TwoLepton_CR1', 'MuMu', PNs[0],  UnblindData=True, Logy=0, TLatexAlias='#mu#mu', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_WpWp_TwoLepton_CR1', 'EE', PNs[0],  UnblindData=True, Logy=0, TLatexAlias='ee', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_WpWp_TwoLepton_CR2', 'MuMu', PNs[0],  UnblindData=True, Logy=0, TLatexAlias='#mu#mu', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_WpWp_TwoLepton_CR2', 'EE', PNs[0],  UnblindData=True, Logy=0, TLatexAlias='ee', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
