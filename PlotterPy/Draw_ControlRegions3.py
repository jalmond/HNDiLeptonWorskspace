...
if args.Category==0:
  ...
  m.RegionsToDraw = [
    ...
    Region('HNL_HighMassSR3_TwoLepton_CR', 'MuMu', PNs[0],  UnblindData=True, Logy=0, TLatexAlias='#mu#mu', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_HighMassSR3_TwoLepton_CR', 'EE', PNs[0],  UnblindData=True, Logy=0, TLatexAlias='ee', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
