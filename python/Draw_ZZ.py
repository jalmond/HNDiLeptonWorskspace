...
if args.Category==0:
  ...
  #### Define reiongs
  m.RegionsToDraw = [
    Region('HNL_ZZLoose_FourLepton_CR_OptID_Electron' , 'Electron', UnblindData=True, Logy=0, TLatexAlias='#splitline{eeee}{ZZ->llll CR}'),
    Region('HNL_ZZLoose_FourLepton_CR_Version1_Electron' , 'Electron', UnblindData=True, Logy=0, TLatexAlias='#splitline{eeee}{ZZ->llll CR}'),
    Region('HNL_ZZ_FourLepton_CR_OptID_Electron' , 'Electron', UnblindData=True, Logy=0, TLatexAlias='#splitline{eeee}{ZZ->llll CR}'),
    Region('HNL_ZZ_FourLepton_CR_Version1_Electron' , 'Electron', UnblindData=True, Logy=0, TLatexAlias='#splitline{eeee}{ZZ->llll CR}'),
  ]
  m.PrintRegions()
...
m.VariablesToDraw = [
  ...
  Variable('M_llll', 'Mass (llll) (GeV)', 'GeV'),
  Variable('M_Z1', 'Mass Z1 (GeV)', 'GeV'),
  Variable('M_Z2', 'Mass Z2 (GeV)', 'GeV'),
]
m.PrintVariables()
