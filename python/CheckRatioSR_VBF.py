...
for era in eras:
    ...
    h_sig_sr5= h_dy.Clone("h_sig_SR5_mm"+era)
    ...
    for x in sig_mass_list :
        ...
        if os.path.exists("/data6/Users/jalmond/SKFlatOutput/Run2UltraLegacy_v3/HNL_SignalStudies/"+era+"/HNL_SignalStudies_"+sigVBF+".root"):
            ...
            if h_sig:
                tot_SR1 = tot_SR1 +  h_sig.GetBinContent(16)
                tot_SR1F = tot_SR1F +  h_sig.GetBinContent(17)
                tot_SR2 = tot_SR2 +  h_sig.GetBinContent(18)
                tot_SR3 = tot_SR3 +  h_sig.GetBinContent(19)
                tot_SR3F = tot_SR3F +  h_sig.GetBinContent(22)
                tot_SR4 = tot_SR4 +  h_sig.GetBinContent(20)
                tot_SR5 = tot_SR5 +  h_sig.GetBinContent(21)
        ...
        tot_SR = tot_SR1+tot_SR1F+tot_SR2+tot_SR3+tot_SR3F+tot_SR4 + tot_SR5
        print "sigVBF = " + str(sigVBF) + " tot_SR=" + str(tot_SR) + " tot_SR1="+str(tot_SR1)
        print (tot_SR1 / tot_SR)
        ...
        h_sig_sr5.Fill(nmass, tot_SR5 / tot_SR)
    ...
    h_sig_sr3.Add(h_sig_sr5)


    h_sig_sr4.Add(h_sig_sr5)
    ...
    lg.AddEntry( h_sig_sr5, 'SR5 MM', 'f')
    lg.AddEntry( h_sig_sr3FAIL, 'FAIL SR3 MM', 'f')
      

    lg.Draw()
    
    print 'Saving ==> '+outdir+'/HIST_'+era+'_SRSplit_official.pdf'

    c1.SaveAs(outdir+'/HIST_'+era+'_SRSplit_official.pdf')
    c1.SaveAs(outdir+'/HIST_'+era+'_SRSplit_official.png')
    os.system("ssh jalmond@lxplus.cern.ch 'mkdir -p /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_VBF/'")
    os.system("ssh jalmond@lxplus.cern.ch 'cp  /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit/index.php /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_VBF/'")
    os.system("scp " + outdir+"/HIST_"+era+"_SRSplit_official.pdf  jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_VBF/")
    os.system("scp " + outdir+"/HIST_"+era+"_SRSplit_official.png jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_VBF/")
