...
for era in eras:
    ...
    os.system("scp " + outdir+"/HIST_"+era+"_SRSplit.pdf  jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit/")
    os.system("scp " + outdir+"/HIST_"+era+"_SRSplit.png jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit/")
