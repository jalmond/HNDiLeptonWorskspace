...
for era in eras:
    ...
    for x in sig_mass_list :
        ...
        sigVBF="VBFTypeI_DF_M"

        sigVBF =  "VBFTypeI_DF_M"+str(x)+"_private"
        ...
        if os.path.exists("/data6/Users/jalmond/SKFlatOutput/Run2UltraLegacy_v3/HNL_SignalStudies/"+era+"/HNL_SignalStudies_"+sigVBF+".root"):
            ...
            eff_MM=0
            if h_sig:
                eff_MM =  h_sig.GetBinContent(16) / h_sig.GetBinContent(1)
    ...
    c1.SaveAs(outdir+'/Graph_'+era+'_Efficiency_SR1_VBF_private.pdf')
    c1.SaveAs(outdir+'/Graph_'+era+'_Efficiency_SR1_VBF_private.png')

    os.system("ssh jalmond@lxplus.cern.ch 'mkdir -p /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/Efficiency/'")    
    os.system("scp " + outdir+"/Graph_"+era+"_Efficiency_SR1_VBF_private.png jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/Efficiency/")
    os.system("scp " + outdir+"/Graph_"+era+"_Efficiency_SR1_VBF_private.pdf jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/Efficiency/")
