...
for channel in channels:
    ...
    for mass in masses:
        ...
        DirName = "LimitInput"
        HistName="/HNLOpt_UL_ElOpt_HNLUL_POGT_ConvBConvEC_LooseTrig_CFMVABB10p85_CFMVABB20p85_CFMVAPt60_CFMVAEC10p85_CFMVAEC20p85__DXYv1/FillEventCutflow/ElectronSR"
        if mass == "100":
            DirName = "LimitInputBDT"
            HistName="/HNLOpt_UL_ElOpt_HNLUL_POGT_ConvBConvEC_LooseTrig_CFMVABB10p85_CFMVABB20p85_CFMVAPt60_CFMVAEC10p85_CFMVAEC20p85__DXYv1/100/FillEventCutflow/ElectronSR"
        ...
        for x in HistNames:
            ...
            if not _hist in sample_dict:
                ...
                #/HNLOpt_ULHNTightPFIsoLoose/500/FillEventCutflow/ElectronSR x
