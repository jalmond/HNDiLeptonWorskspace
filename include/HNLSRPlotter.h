#ifndef HNLSRPlotter_h
#define HNLSRPlotter_h
...
public:
  //==== constructors
  HNLSRPlotter(TString macroname);
  ~HNLSRPlotter();
  ...
  vector<double> signal_scale;
  vector<TString> signal_leg;
  vector<TString> signal_string;
