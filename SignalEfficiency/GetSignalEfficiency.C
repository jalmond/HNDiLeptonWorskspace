...
void GetSignalEfficiency(){ 
  ...
  samples.push_back("125");
  samples.push_back("200");
  samples.push_back("250");
  ...
  TString outfile = "HNEfficiencies_highmass.root";
  ...
  for(unsigned int j = 0 ; j < SR.size(); ++j){
	...
	TH1D* this_hist = new TH1D(_sr+"_"+channel_lab +"_highmass"+sign +"_njets_HNtypeI_JA_"+channel_lab+"_" + ID , "", masses.size(), 0, masses.size());
	...
	for(unsigned int i = 0 ; i < masses.size(); ++i){
	  ...
	  TFile * filemm = new TFile(("/data6/Users/jalmond/SKFlatOutput//Run2Legacy_v4/HNtypeI_JA/2016/"+_sign+"/HNtypeI_JA_HN_Schannel_"+channel[k].first+"_"+im+"_nlo.root").Data());
	  TFile * filepp = new TFile(("/data6/Users/jalmond/SKFlatOutput//Run2Legacy_v4/HNtypeI_JA/2016/"+_sign+"/HNtypeI_JA_HN_Schannel_"+channel[k].first+"_"+im+"_nlo.root").Data());
	  
	  if(!filemm) continue;
	  if(!filepp) continue;
	  TString hist = _sr + "_"+channel_lab + "_highmass"+sign+"/"+_sr+"_"+channel_lab +"_highmass"+sign +"_njets_HNtypeI_JA_"+channel_lab+"_" + ID +"_";
	...
	TCanvas* c1 = new TCanvas((_sr+"_"+channel_lab +"_highmass"+sign +"_njets_HNtypeI_JA_"+channel_lab+"_" + ID), _sr+"_"+channel_lab +"_highmass"+sign +"_njets_HNtypeI_JA_"+channel_lab+"_" + ID, 1600, 1200);
	this_hist->Draw("colz text");
	c1->SaveAs((_sr+"_"+channel_lab +"_highmass"+sign +"_njets_HNtypeI_JA_"+channel_lab+"_" + ID+".pdf"));
      }
