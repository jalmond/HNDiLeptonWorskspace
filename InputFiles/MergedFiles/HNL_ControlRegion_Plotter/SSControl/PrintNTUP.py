...
MAIN_DIR = os.environ['HNDILEPTONWORKSPACE_DIR']
WORKING_DIR = os.environ['PWD']

sys.path.insert(1, MAIN_DIR+'/python')
...
FilePath=WORKING_DIR+"/MergedSampleDir/"+DateDir+"/"                                                                          
...
outfile_path = "YieldSummary/"
os.system("mkdir -p " +outfile_path)
outfile_path = "YieldSummary/"+DateDir
os.system("mkdir -p " +outfile_path)
outfile_path = outfile_path +"/"+ args.Era + "_"+args.Channel + "_"+args.Flag+"_"+Region+"_Sig.txt"
