...
dmasses = [0] #100,250, 500,800,1200, 2000]#GetEXO_17_028_Masses("",True)
masses = ["0"] #"100","250","500","800","1200","2000"] #GetEXO_17_028_Masses("",True)
...
for channel in channels:
    ...
    for k, o in getall(f_Bkg):
        #print o.ClassName(), k
        if not "MuonChargeSplitSR" in k:
            continue
        if not "0p8_ISOB0p" in k:
            continue
