...
for channel in channels:
    ...
    for mass in masses:
        ...
        for SR in SRs:
            ...
            print channel + " " + SR + " " + str(GetEXO_17_028_Eff(channel, Bin, mass,"DY")) + " " + str(GetXSecUnityCoupling(dmasses[im],"DY")) + " " + str(GetEXO_17_028_Eff(channel, Bin, mass,"VBF")) + " " + str(GetXSecUnityCoupling(dmasses[im],"VBF"))
            ...
            print  channel + " : " + mass + " : " + SR + " " + str(nSig ) + " "  + str(nBkg)
