...
parser.add_argument('--N', dest='N', default=1, type=int, help="maximum running jobs")
...
for channel in channels:
    ...
    for mass in masses:
        filename_log  = open(outdir+'/'+channel + 'log_BB_'+mass+'.txt','w')
        ...
        filename= outdir+'/'+channel + '_OptElectronMVA_BB_3D_'+str(mass)
