...
for era in eras:
    ...
    for x in sig_mass_list :
        ...
        if os.path.exists("/data6/Users/jalmond/SKFlatOutput/Run2UltraLegacy_v3/HNL_SignalStudies/"+era+"/HNL_SignalStudies_"+sigSSWW+".root"):
            ...
            f_sig1 = ROOT.TFile(   "/data6/Users/jalmond/SKFlatOutput/Run2UltraLegacy_v3/HNL_SignalStudies/"+era+"/HNL_SignalStudies_"+sigSSWW+".root")
            
            h_sig1 = f_sig1.Get("MuonChannelSignals/FillEventCutflow_SR/SR_Summary")
            
            print h_sig1
            print "/data6/Users/jalmond/SKFlatOutput/Run2UltraLegacy_v3/HNL_SignalStudies/"+era+"/HNL_SignalStudies_"+sigSSWW+".root"

            if h_sig1:
                tot_SR1 = tot_SR1 +  h_sig1.GetBinContent(7)
                tot_SR1F = tot_SR1F +  h_sig1.GetBinContent(8)
                tot_SR2 = tot_SR2 +  h_sig1.GetBinContent(9)
                tot_SR2F = tot_SR2F +  h_sig1.GetBinContent(10)
                tot_SR3 = tot_SR3 +  h_sig1.GetBinContent(11)
                tot_SR3F = tot_SR3F +  h_sig1.GetBinContent(13)
                tot_SR4 = tot_SR4 +  h_sig1.GetBinContent(12)
    ...
    os.system("ssh jalmond@lxplus.cern.ch 'mkdir -p /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_SSWW/'")

    os.system("ssh jalmond@lxplus.cern.ch 'cp  /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit/index.php /afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_SSWW/'")

    os.system("scp " + outdir+"/HIST_"+era+"_SRSplit.pdf  jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_SSWW/")
    os.system("scp " + outdir+"/HIST_"+era+"_SRSplit.png jalmond@lxplus.cern.ch:/afs/cern.ch/user/j/jalmond/www/SNU/WebPlots/HNL/SignalStudies/SignalSplit_SSWW/")
