...
void makeshapeinputSS(int k=0,TString analysername="HNtypeI_Dilepton"){
  ...
  vector<TString> Bins={"SR1","SR2"};//,"SR2"};
  ...
  //IDMu     = 
  //  IDEl     = passTightID,HNTight2016,passTightID_nocc,HNTightV1,HNTightV2,HNTightV3,HNMediumV1,HNMediumV2,HNMediumV3,passMediumID,passMVAID_noIso_WP80,passMVAID_noIso_WP90,passMVAID_iso_WP80,passMVAID_iso_WP90
	...
	for(const auto& channel: Channels) {
	  ...
	  for(const auto& id: IDs) {
	    ...
	    if(charge=="same_sign"){
	      ...
	      samples.push_back(make_pair("fake","Fake"+flavour)); // TTLJ_powheg", "WJets_MG","SingleTop"
