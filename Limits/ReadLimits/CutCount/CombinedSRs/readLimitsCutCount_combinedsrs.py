...
for _iter in range(0,niter):
       ...
       for _id in IDs:
              ...
              for mass in _masses:
                     ...
                     _filename = Limitdir+  input_dir+"/higgsCombinecard_"+year+"_"+flavour + "_combined_"+_sr+"_N"+mass+channel_tag+"_"+_id+".txt_exp0.500.HybridNew.mH120.quant0.500.root"   

                     if os.path.exists(_filename):
                            os.system("root -l -q -b 'ReadLimitFromTree.C(\"/data6/Users/jalmond/Limits/CMSSW_10_2_13/src/HiggsAnalysis/CombinedLimit/data/2016_HNDiLepton/batch/"+input_dir+"/higgsCombinecard_"+year+"_"+flavour+"_combined_"+_sr+"_N"+mass+channel_tag+"_"+_id+".txt_exp0.500.HybridNew.mH120.quant0.500.root\",\"test\")'")
