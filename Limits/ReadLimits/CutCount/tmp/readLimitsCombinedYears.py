       ...
       for flavour in Flavours:
              ...
              for _id in IDs:
                     for _bin in bins:
                            ...
                            if not os.path.exists("out/HNTypeI_JA/CombinedYears/"):
                                   os.mkdir("out/HNTypeI_JA/CombinedYears/")
                            if not os.path.exists("out/HNTypeI_JA/CombinedYears/"+_allmassfilename):
                                   os.mkdir ("out/HNTypeI_JA/CombinedYears/"+_allmassfilename)

                            outfile = open("out/HNTypeI_JA/CombinedYears/"+_allmassfilename +"/result_combined_"+_id+".txt","w")
                            ...
                            for mass in Masses:
                                   ...
                                   Expected_2sdUp = "--"
                                   Expected_2sdDn = "--"
                                   #MuMu_CombinedSS_MuMu_N125_combinedallyears_POGTightPFIsoVeryTight.txt
                                   tag = flavour+"_CombinedSS_"+flavour+"_N"+mass+"_combinedallyears_"+_id
                                   
                                   if mass == "1300" or mass == "1200" :
                                          tag = flavour+"_CombinedSS_"+flavour+"_N1100_combinedallyears_"+_id

                           
                                   if mass == "125": 
                                          tag = flavour+"_CombinedSS_"+flavour+"_N125_combinedallyears_"+_id

                                   if mass == "250":
                                          tag = flavour+"_CombinedSS_"+flavour+"_N250_combinedallyears_"+_id
