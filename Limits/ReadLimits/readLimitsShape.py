...
_vars = ["signalbin","ml1jj","ml2jj","mlljj"]
IDs = ["POGTightWithTightIso", "HNTightV2","HNTightV1"]
            ...
            for channel in Channels:
                   for _id in IDs:
                     for _var in _vars:
                            ...
                            outfile = open("out/"+ year+"/"+_allmassfilename +"/result"+channel+"_"+_id+"_"+_var+".txt","w")
                            print "Creating file  out/"+ year+"/"+_allmassfilename +"/result"+channel+"_"+_id+"_"+_var+".txt"
                            for mass in Masses:
