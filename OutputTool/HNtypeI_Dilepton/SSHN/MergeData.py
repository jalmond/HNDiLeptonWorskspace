...
for d in datalist:
    ...
    for dataset in d[1]:
        ...
        print " "
        print hadd
        if os.path.exists(outpath + analyzername+"_SkimTree_SSHN_"+dataset + ".root"):
            os.system("rm " + outpath + analyzername+"_SkimTree_SSHN_"+dataset + ".root")
    ...
    if "SingleMuon" in d[1]:
        print "hadd " + outpath + analyzername+"_SkimTree_SSHN_Muon.root  " + outpath + analyzername+"_SkimTree_SSHN_DoubleMuon.root  "+  outpath + analyzername+"_SkimTree_SSHN_SingleMuon.root  "
        if os.path.exists(outpath + analyzername+"_SkimTree_SSHN_Muon.root"):
            os.remove(outpath + analyzername+"_SkimTree_SSHN_Muon.root")
        os.system("hadd " + outpath + analyzername+"_SkimTree_SSHN_Muon.root  " + outpath + analyzername+"_SkimTree_SSHN_DoubleMuon.root  "+  outpath + analyzername+"_SkimTree_SSHN_SingleMuon.root  ")
    else:
        if os.path.exists(outpath + analyzername+"_SkimTree_SSHN_Muon.root"):
            os.remove(outpath + analyzername+"_SkimTree_SSHN_Muon.root")

        print "mv " + outpath + analyzername+"_SkimTree_SSHN_DoubleMuon.root " + outpath + analyzername+"_SkimTree_SSHN_Muon.root"
        os.system("mv " + outpath + analyzername+"_SkimTree_SSHN_DoubleMuon.root " + outpath + analyzername+"_SkimTree_SSHN_Muon.root")
